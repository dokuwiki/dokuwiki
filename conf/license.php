...
$license['cc-zero'] = array(
    ...
    'url'  => 'http://creativecommons.org/publicdomain/zero/1.0/deed.'.$conf['lang'],
);
$license['publicdomain'] = array(
    'name' => 'Public Domain',
    'url'  => 'http://creativecommons.org/licenses/publicdomain/deed.'.$conf['lang'],
);
$license['cc-by'] = array(
    'name' => 'CC Attribution 4.0 International',
    'url'  => 'http://creativecommons.org/licenses/by/4.0/deed.'.$conf['lang'],
);
$license['cc-by-sa'] = array(
    'name' => 'CC Attribution-Share Alike 4.0 International',
    'url'  => 'http://creativecommons.org/licenses/by-sa/4.0/deed.'.$conf['lang'],
);
$license['gnufdl'] = array(
    'name' => 'GNU Free Documentation License 1.3',
    'url'  => 'http://www.gnu.org/licenses/fdl-1.3.'.$conf['lang'].'.html',
);
$license['cc-by-nc'] = array(
    'name' => 'CC Attribution-Noncommercial 4.0 International',
    'url'  => 'http://creativecommons.org/licenses/by-nc/4.0/deed.'.$conf['lang'],
);
$license['cc-by-nc-sa'] = array(
    'name' => 'CC Attribution-Noncommercial-Share Alike 4.0 International',
    'url'  => 'http://creativecommons.org/licenses/by-nc-sa/4.0/deed.'.$conf['lang'],
);
