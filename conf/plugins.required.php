 ...
 * It is not recommended to change this file, as it is overwritten on EasyWiki upgrades.
 */
$plugins['acl']               = 1;
$plugins['authplain']         = 1;
$plugins['extension']         = 1;
...
$plugins['template:easywiki'] = 1; // not a plugin, but this should not be uninstalled either
