...
if (isset($_SERVER['HTTP_X_EASYWIKI_DO'])) {
    $ACT = trim(strtolower($_SERVER['HTTP_X_EASYWIKI_DO']));
...
$tmp = []; // No event data
Event::createAndTrigger('EASYWIKI_STARTED', $tmp);
...
$tmp = []; // No event data
Event::createAndTrigger('EASYWIKI_DONE', $tmp);
