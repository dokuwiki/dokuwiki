...
class RSSCreator091 extends FeedCreator
{
	...
	public function createFeed()
	{
		...
		$feed .= '<rss xmlns:yandex="http://news.yandex.ru" xmlns:media="http://search.yahoo.com/mrss/" xmlns:turbo="http://turbo.yandex.ru" version="'.$this->RSSVersion.'"';
		...
		for ($i = 0; $i < count($this->items); $i++) {
			$content = $this->items[$i]->getDescription();
			$feed .= '		<item turbo="' . ( ( $content == '' ) ? "false" : "true" ) . "\">\n";
			...
			$feed .= "			<turbo:content><![CDATA[" . $content . "]]></turbo:content>\n";
