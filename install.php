...
/*><div style="width:60%; margin: auto; background-color: #fcc;
    ...
    enable PHP before you can install and run EasyWiki. Contact your hosting
...
if (!defined('DOKU_LOCAL')) define('DOKU_LOCAL', WIKI_INC . 'conf/');

// load and initialize the core system
require_once(WIKI_INC . 'inc/init.php');
require_once(WIKI_INC . 'inc/pageutils.php');
...
// language strings
require_once(WIKI_INC . 'inc/lang/en/lang.php');
if (isset($_REQUEST['l']) && !is_array($_REQUEST['l'])) {
    $LC = preg_replace('/[^a-z\-]+/', '', $_REQUEST['l']);
}
if (empty($LC)) $LC = 'en';
if ($LC && $LC != 'en') {
    require_once(WIKI_INC . 'inc/lang/' . $LC . '/lang.php');
}
...
?>
    ...
    <body style="">
    <h1 style="float:left">
        <img src="lib/exe/fetch.php?media=wiki:easywiki-128.png"
    ...
    <div style="float: right; width: 34%;">
        <?php
        if (file_exists(WIKI_INC . 'inc/lang/' . $LC . '/install.html')) {
            include(WIKI_INC . 'inc/lang/' . $LC . '/install.html');
        } else {
            echo "<div lang=\"en\" dir=\"ltr\">\n";
            include(WIKI_INC . 'inc/lang/en/install.html');
            echo "</div>\n";
        }
        ?>
        <a style="
...
<?php
/**
 * EasyWiki's Main Configuration File - Local Settings
...
EOT;
    ...
    if (isset($d['pop']) && $d['pop']) {
        @touch(WIKI_INC . 'data/cache/autosubmit.txt');
    }
...
function check_permissions()
{
    ...
    $dirs = [
        'conf' => DOKU_LOCAL,
        'data' => WIKI_INC . 'data',
        'pages' => WIKI_INC . 'data/pages',
        'attic' => WIKI_INC . 'data/attic',
        'media' => WIKI_INC . 'data/media',
        'media_attic' => WIKI_INC . 'data/media_attic',
        'media_meta' => WIKI_INC . 'data/media_meta',
        'meta' => WIKI_INC . 'data/meta',
        'cache' => WIKI_INC . 'data/cache',
        'locks' => WIKI_INC . 'data/locks',
        'index' => WIKI_INC . 'data/index',
        'tmp' => WIKI_INC . 'data/tmp'
    ];
...
/**
 * Check the availability of functions used in EasyWiki and the PHP version
 *
 * @return bool
 *
