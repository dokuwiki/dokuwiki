/* global jQuery, WIKI_BASE, WIKI_UHC, JSINFO, LANG, DWgetSelection, pasteText */
...
class LinkWizard {
    ...
    selected = -1;
    /** @var {Object} selection A EasyWiki selection object holding text positions in the editor */
    selection = null;
    ...
    autocomplete_exec() {
        ...
        this.deselect();
        $res.html('<img src="' + WIKI_BASE + 'lib/images/throbber.gif" alt="" width="16" height="16" />')
            .load(
