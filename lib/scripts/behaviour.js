...
var dw_behaviour = {
    ...
    pageRestoreConfirm: function(){
        jQuery('#easywiki__pagetools li.revert a').on('click',
            function() {
    ...
    securityCheck: function () {
        ...
        if (sessionStorage.getItem('dw-security-check:' + WIKI_BASE)) {
        ...
        img.onerror = function () {
            ...
            $checkDiv.remove();
            sessionStorage.setItem('dw-security-check:' + WIKI_BASE, true);
        };
        img.onload = function () {
