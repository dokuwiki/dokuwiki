...
var dw_mediamanager = {
    ...
    init: function () {
        ...
        $tree.dw_tree({
            ...
            toggle_display: function ($clicky, opening) {
                $clicky.attr('src', WIKI_BASE + 'lib/images/' + (opening ? 'minus' : 'plus') + '.gif');
            }
        });
        ...
        jQuery.each(opts, function (_, opt) {
            ...
            jQuery.each(opt.btns, function (i, text) {
                ...
                $img = jQuery(document.createElement('img'))
                    .attr('src', WIKI_BASE + 'lib/images/media_' + opt.id + '_' + text + '.png');
    ...
    update_content: function ($content, params, update_list) {
        ...
        $container.html('<img src="' + WIKI_BASE + 'lib/images/throbber.gif" alt="..." class="load" />');
    },
    ...
    init_ajax_uploader: function () {
        ...
        var uploader = new qq.FileUploaderExtended({
            ...
            action: WIKI_BASE + 'lib/exe/ajax.php',
            params: params
        });
    },
    ...
    select: function (event) {
        ...
        if (!opener) {
            ...
            // the id's are a bit wierd and jQuery('#ex_wiki_easywiki-128.png')
