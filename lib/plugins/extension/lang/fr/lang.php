...
$lang['status_bundled']        = 'được đi kèm';
...
$lang['update_available']      = '<strong>Cập nhật:</strong> Phiên bản %s mới hiện có sẵn.';
...
$lang['error_decompress']      = 'Không thể giải nén tập tin đã tải xuống. Việc này có thể là kết quả của một tải xuống xấu, trường hợp này bạn nên thử lại; hoặc nếu khả năng định dạng nén không xác định, bạn sẽ cần phải tải xuống và cài đặt thủ công.';
$lang['error_findfolder']      = 'Không thể xác định đường dẫn phần mở rộng, bạn cần tải xuống và cài đặt thủ công';
$lang['error_copy']            = 'Có lỗi sao chép tập tin trong khi đang cố gắng cài đặt tập tin cho đường dẫn <em>%s</em>: đĩa có thể đầy hoặc quyền truy cập tập tin có thể không chính xác. Việc này có thể đã dẫn đến plugin được cài đặt một phần và khiến cài đặt wiki của bạn không ổn định';
