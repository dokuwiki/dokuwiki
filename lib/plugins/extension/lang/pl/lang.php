...
$lang['js']['close']           = 'Kliknij, aby zamknąć';
$lang['js']['filter']          = 'Pokaż tylko rozszerzenia, które można aktualizować';
...
$lang['msg_install_success']   = 'Rozszerzenie %s zostało pomyślnie zainstalowane';
$lang['msg_update_success']    = 'Rozszerzenie %s zostało pomyślnie zaktualizowane';
...
$lang['found_conflict']        = 'To rozszerzenie jest oznaczone jako powodujące konflikt z następującymi zainstalowanymi rozszerzeniami: %s';
...
$lang['error_copy_read']       = 'Nie można odczytać katalogu %s';
$lang['error_copy_mkdir']      = 'Nie można utworzyć katalogu %s';
$lang['error_copy_copy']       = 'Nie można skopiować %s do %s';
$lang['error_archive_read']    = 'Nie można otworzyć archiwum %s do odczytu';
$lang['error_archive_extract'] = 'Nie można wyodrębnić archiwum %s: %s';
$lang['error_uninstall_protected'] = 'Rozszerzenie %s jest chronione i nie można go odinstalować';
$lang['error_uninstall_dependants'] = 'Rozszerzenie %s jest nadal wymagane przez %s i dlatego nie można go odinstalować';
$lang['error_disable_protected'] = 'Rozszerzenie %s jest chronione i nie można go wyłączyć';
$lang['error_disable_dependants'] = 'Rozszerzenie %s jest nadal wymagane przez %s i dlatego nie można go wyłączyć';
$lang['error_nourl']           = 'Nie znaleziono adresu URL do pobrania dla rozszerzenia %s';
$lang['error_notinstalled']    = 'Rozszerzenie %s nie jest zainstalowane';
$lang['error_alreadyenabled']  = 'Rozszerzenie %s zostało już włączone';
$lang['error_alreadydisabled'] = 'Rozszerzenie %s zostało już wyłączone';
$lang['error_minphp']          = 'Rozszerzenie %s wymaga co najmniej PHP %s, ale ta wiki obsługuje PHP %s';
$lang['error_maxphp']          = 'Rozszerzenie %s obsługuje tylko PHP do %s, ale ta wiki obsługuje PHP %s';
...
$lang['repo_error']            = 'Nie można skontaktować się z repozytorium wtyczek. Upewnij się, że twój serwer może skontaktować się z www.EasyWiki.org i sprawdzić ustawienia serwera proxy.';
$lang['nossl']                 = 'Twój PHP wydaje się nie obsługiwać protokołu SSL. Pobieranie nie zadziała dla wielu rozszerzeń EasyWiki.';
$lang['popularity_high']       = 'To jedno z najpopularniejszych rozszerzeń';
$lang['popularity_medium']     = 'To rozszerzenie jest dość popularne';
$lang['popularity_low']        = 'To rozszerzenie wzbudziło pewne zainteresowanie';
