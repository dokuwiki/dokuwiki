...
class Writer {
    ...
    public function isLocked() {
        ...
        return file_exists($this->savefile) && !is_writable($this->savefile);
    }
    ...
    protected function getHeader() {
        return implode(
            "\n",
            ['<?php', '/*', ' * ' . $this->header, ' * Auto-generated by config plugin', ' * Run for user: ' . ($_SERVER['REMOTE_USER'] ?? 'Unknown'), ' * Date: ' . date('r'), ' */', '', '']
        );
    }
}
