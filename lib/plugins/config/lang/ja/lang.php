...
$lang['basedir']               = 'サーバのパス (例: <code>/easywiki/</code>)<br>空欄にすると自動的に検出します。';
...
$lang['disableactions']        = 'EasyWiki の動作を無効にする';
...
$lang['updatecheck']           = 'EasyWikiの更新とセキュリティに関する情報をチェックする（この機能は update.dokuwiki.org への接続が必要です。）';
...
$lang['renderer__core']        = '%s （EasyWikiコア）';
...
$lang['userewrite_o_2']        = 'EasyWikiによる設定';
