...
$lang['mailreturnpath']        = 'メール配信不能通知を受信するメールアドレス';
...
$lang['search_nslimit']        = '現在の名前空間 X に限定して検索する。階層がより深い名前空間から検索が実行された場合、最初の名前空間 X がフィルターとして追加されます。';
$lang['search_fragment']       = '断片検索のデフォルトの挙動を指定する';
