...
$lang['_header_easywiki']      = 'Настройки на EasyWiki';
...
$lang['basedir']               = 'Главна директория (напр. <code>/easywiki/</code>). Оставете празно, за да бъде засечена автоматично.';
...
$lang['disableactions']        = 'Изключване функции на EasyWiki';
...
$lang['remote']                = 'Включване на системата за отдалечен API достъп. Това ще позволи на приложения да се свързват с EasyWiki чрез XML-RPC или друг механизъм.';
...
$lang['updatecheck']           = 'Проверяване за за нови версии и предупреждения за сигурността? Необходимо е Dokiwiki да може да се свързва със update.easywiki.org за тази функционалност.';
...
$lang['renderer__core']        = '%s (ядрото на EasyWiki)';
$lang['renderer__plugin']      = '%s (приставка)';
$lang['dnslookups']            = 'EasyWiki ще търси имената на хостовете, на отдалечени IP адреси, от които потребители редактират страници. НЕ е желателно да ползвате опцията ако имате бавен или неработещ DNS сървър.';
...
$lang['userewrite_o_2']        = 'вътрешно от EasyWiki ';
