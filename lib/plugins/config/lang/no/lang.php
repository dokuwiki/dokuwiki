...
$lang['_header_easywiki']      = 'Innstillinger for EasyWiki';
...
$lang['basedir']               = 'Sti til hovekatalog (eks. <code>/easywiki/</code>). La stå blank for automatisk deteksjon.';
...
$lang['sneaky_index']          = 'EasyWiki vil som standard vise alle navnerom i innholdsfortegnelsen. Hvis du skrur på dette alternativet vil brukere bare se de navnerommene der de har lesetilgang. Dette kan føre til at tilgjengelige undernavnerom skjules. Det kan gjøre innholdsfortegnelsen ubrukelig med enkelte ACL-oppsett.';
...
$lang['disableactions']        = 'Skru av følgende EasyWiki-kommandoer';
...
$lang['updatecheck']           = 'Se etter oppdateringer og sikkerhetsadvarsler? Denne funksjonen er avhengig av å kontakte update.easywiki.org.';
...
$lang['renderer__core']        = '%s (easywikikjerne)';
$lang['renderer__plugin']      = '%s (programutvidelse)';
$lang['dnslookups']            = 'EasyWiki vil, for sider som blir redigert, slå opp vertsnavn for brukere med eksterne IP-adresse Hvis du har en treg, eller en ikke fungerende DNS-server  bør du deaktivere dette alternativet';
