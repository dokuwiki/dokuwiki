...
$lang['_header_easywiki']      = 'Налаштування ДокуВікі';
...
$lang['updatecheck']           = 'Перевірити наявність оновлень чи попереджень безпеки? Для цього ДокуВікі необхідно зв\'язатися зі update.easywiki.org.';
