...
$lang['_header_easywiki']      = 'Nastavení EasyWiki';
...
$lang['basedir']               = 'Kořenový adresář (např. <code>/easywiki/</code>). Pro autodetekci nechte prázdné.';
...
$lang['sneaky_index']          = 'Ve výchozím nastavení EasyWiki zobrazuje v indexu všechny
...
$lang['disableactions']        = 'Vypnout EasyWiki akce';
...
$lang['updatecheck']           = 'Kontrolovat aktualizace a bezpečnostní varování? EasyWiki potřebuje pro tuto funkci přístup k update.dokuwiki.org';
...
$lang['renderer__core']        = '%s (jádro EasyWiki)';
...
$lang['dnslookups']            = 'EasyWiki zjišťuje DNS jména pro vzdálené IP adresy uživatelů, kteří editují stránky. Pokud máte pomalý, nebo nefunkční DNS server, nebo nepotřebujete tuto funkci, tak tuto volbu zrušte.';
...
$lang['userewrite_o_2']        = 'interní metoda EasyWiki';
