...
$lang['_header_easywiki']      = 'Impostazioni EasyWiki';
...
$lang['sneaky_index']          = 'Normalmente, EasyWiki mostra tutte le categorie nella vista indice. Abilitando questa opzione, saranno nascoste quelle per cui l\'utente non ha il permesso in lettura. Questo potrebbe far sì che alcune sottocategorie accessibili siano nascoste. La pagina indice potrebbe quindi diventare inutilizzabile con alcune configurazioni dell\'ACL.';
...
$lang['disableactions']        = 'Disabilita azioni EasyWiki';
...
$lang['updatecheck']           = 'Controllare aggiornamenti e avvisi di sicurezza? EasyWiki deve contattare update.dokuwiki.org per questa funzione.';
...
$lang['renderer__core']        = '%s (easywiki)';
...
$lang['dnslookups']            = 'EasyWiki farà il lookup dei nomi host per ricavare l\'indirizzo IP remoto degli utenti che modificano le pagine. Se hai un DNS lento o non funzionante o se non vuoi questa funzione, disabilita l\'opzione';
