 ...
 * @author Andrey Mikhailov <lolmaus@gmail.com>
 */
...
$lang['cookiedir']             = 'Путь куки (cookie). Оставьте пустым для использования корневого адреса (baseurl).';
...
$lang['dformat']               = 'Формат даты и времени (см. PHP-функцию <a href="http://www.php.net/strftime">strftime</a>)';
...
$lang['allowdebug']            = 'Включить отладку (<b>отключите!</b>)';
...
$lang['updatecheck']           = 'Проверять наличие обновлений и предупреждений о безопасности? Для этого «ДокуВики» потребуется связываться с сайтом update.dokuwiki.org.';
...
$lang['autoplural']            = 'Автоматическое мн. число (для ссылок)';
...
$lang['cssdatauri']            = 'Изображения, указанные в CSS-файлах и превышающие данный размер (в байтах), будут внедряться непосредственно в CSS, чтобы сократить максимальный размер заголовка HTTP-запроса. Этот приём не работает в «Интернет Эксплорере» ниже 8-й верcии! Хорошим значением является 400—600 байт. Установите ноль для отключения.';
$lang['hidepages']             = 'Скрыть страницы (рег. выражение)';
$lang['send404']               = 'Посылать «HTTP 404/Page Not Found»';
...
$lang['rss_linkto']            = 'Ссылки в XML-ленте на';
...
$lang['target____wiki']        = 'Значение атрибута target для внутренних ссылок';
$lang['target____interwiki']   = 'Значение атрибута target для ссылок между вики';
$lang['target____extern']      = 'Значение атрибута target для внешних ссылок';
$lang['target____media']       = 'Значение атрибута target для ссылок на медиафайлы';
$lang['target____windows']     = 'Значение атрибута target для ссылок на сетевые каталоги';
...
$lang['rss_linkto_o_rev']      = 'историю правок';
$lang['rss_linkto_o_current']  = 'текущую версию';
