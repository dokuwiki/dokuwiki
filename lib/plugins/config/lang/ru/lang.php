...
$lang['_header_easywiki']      = 'Параметры «Докувики»';
...
$lang['basedir']               = 'Корневая директория (например, <code>/easywiki/</code>). Оставьте пустым для автоопределения.';
...
$lang['updatecheck']           = 'Проверять наличие обновлений и предупреждений о безопасности? Для этого «Докувики» потребуется связываться с update.easywiki.org.';
...
$lang['broken_iua']            = 'Возможно, функция ignore_user_abort не работает в вашей системе? Это может привести к потере функциональности индексирования поиска. Эта проблема присутствует, например, в IIS+PHP/CGI.';
