...
$lang['_header_easywiki']      = 'Inställningar för EasyWiki';
...
$lang['sneaky_index']          = 'Som standard visar EasyWiki alla namnrymder på indexsidan. Genom att aktivera det här valet döljer man namnrymder som användaren inte har behörighet att läsa. Det kan leda till att man döljer åtkomliga undernamnrymder, och gör indexet oanvändbart med vissa ACL-inställningar.';
...
$lang['disableactions']        = 'Stäng av funktioner i EasyWiki';
...
$lang['updatecheck']           = 'Kontrollera uppdateringar och säkerhetsvarningar? EasyWiki behöver kontakta update.dokuwiki.org för den här funktionen.';
