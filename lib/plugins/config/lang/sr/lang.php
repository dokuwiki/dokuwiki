...
$lang['_header_easywiki']      = 'Подешавања EasyWiki-ја';
...
$lang['sneaky_index']          = 'По инсталацији EasyWiki ће у индексу приказати све именске просторе. Укључивањем ове опције именски простори у којима корисник нема право читања ће бити сакривени. Консеквенца је да ће и доступни подпростори бити сакривени. Ово доводи до неупотребљивости Права приступа у неким поставкама.';
...
$lang['disableactions']        = 'Искључи EasyWiki наредбе';
...
$lang['updatecheck']           = 'Провера надоградњи и сигурносних упозорења? EasyWiki мора да контактира update.dokuwiki.org ради добијања информација.';
...
$lang['renderer__core']        = '%s (easywiki језгро)';
...
$lang['userewrite_o_2']        = 'EasyWiki интерно';
