...
$lang['_header_easywiki']      = 'Ρυθμίσεις EasyWiki';
...
$lang['sneaky_index']          = 'Εξ ορισμού, η εφαρμογή EasyWiki δείχνει όλους τους φακέλους στην προβολή Καταλόγου. Ενεργοποιώντας αυτή την επιλογή, δεν θα εμφανίζονται οι φάκελοι για τους οποίους ο χρήστης δεν έχει δικαιώματα ανάγνωσης αλλά και οι υπο-φάκελοί τους ανεξαρτήτως δικαιωμάτων πρόσβασης.';
...
$lang['disableactions']        = 'Απενεργοποίηση λειτουργιών EasyWiki';
...
$lang['updatecheck']           = 'Έλεγχος για ύπαρξη νέων εκδόσεων και ενημερώσεων ασφαλείας της εφαρμογής? Απαιτείται η σύνδεση με το update.easywiki.org για να λειτουργήσει σωστά αυτή η επιλογή.';
...
$lang['renderer__core']        = '%s (βασικός κώδικας easywiki)';
...
$lang['dnslookups']            = 'Το EasyWiki θα ψάξει τα ονόματα υπολογιστών που αντιστοιχούν σε διευθύνσεις IP των χρηστών που γράφουν στις σελίδες. Αν ο DNS είναι αργός, δεν δουλεύει ή δεν χρειάζεστε αυτή την λειτουργία, απενεργοποιήστε την.';
...
$lang['userewrite_o_2']        = 'από EasyWiki';
