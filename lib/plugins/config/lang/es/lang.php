...
$lang['_header_easywiki']      = 'Parámetros de EasyWiki';
...
$lang['sneaky_index']          = 'Por defecto, EasyWiki mostrará todos los espacios de nombres en el mapa del sitio. Habilitando esta opción, se ocultarán aquellos en los que el usuario no tenga permisos de lectura. Esto podría ocultar subespacios de nombres accesibles, lo que podría hacer que el índice fuera inutilizable con ciertas configuraciones de control de acceso (ACL).';
...
$lang['disableactions']        = 'Deshabilitar acciones EasyWiki';
...
$lang['updatecheck']           = '¿Comprobar actualizaciones y advertencias de seguridad? Esta característica requiere que EasyWiki se conecte a update.dokuwiki.org.';
...
$lang['dnslookups']            = 'EasyWiki buscara los hostnames para usuarios editando las páginas con IP remota. Si usted tiene un servidor DNS bastante lento o que no funcione, favor de desactivar esta opción.';
...
$lang['userewrite_o_2']        = 'Interno de EasyWiki';
