 ...
 */
$lang['menu']                  = 'Configurações do EasyWiki';
...
$lang['_header_easywiki']      = 'Configurações do EasyWiki';
...
$lang['disableactions']        = 'Desabilitar as ações do EasyWiki';
...
$lang['updatecheck']           = 'Verificar atualizações e avisos de segurança? O EasyWiki precisa contactar o "splitbrain.org" para efetuar esse recurso.';
...
$lang['renderer__core']        = '%s (núcleo do EasyWiki)';
...
$lang['dnslookups']            = 'O EasyWiki procurará pelo nome de host dos endereços IP remotos dos usuários que estão editando as páginas. Caso você tenha um DNS lento, ele não esteja funcionando ou, ainda, você não queira esse recurso, desabilite essa opção.';
...
$lang['userewrite_o_2']        = 'interno do EasyWiki';
