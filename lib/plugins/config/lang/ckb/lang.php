...
$lang['_header_easywiki']      = 'دۆکوویکی';
...
$lang['basedir']               = 'ڕێڕەوی سێرڤەر (eg. <code>/easywiki/</code>). چۆڵی بە جێبهێڵە بۆ دۆزینەوەی خۆکار.';
...
$lang['updatecheck']           = 'پشکنینی نوێکردنەوەو ئاگاداریەکانی پاراستن؟ EasyWiki پێویستە پەیوەندی بکات update.easywiki.org بۆ ئەم تایبەتمەندیە.';
...
$lang['broken_iua']            = 'ئایا ignore_user_abort لە سیستەمەکەت دا تێکچووە؟ ئەمە لەوانەیە دەبێتە هۆی کارنەکردنی گەڕانی ئیندێکس. IIS+PHP/CGI ناسراوە بە شکاوی. بڕوانە <a href="http://bugs.EasyWiki.org/?do=details&amp;task_id=852">Bug 852</a> بۆ زانیاری زیاتر.';
...
$lang['dnslookups']            = 'EasyWiki بەدوای ناوی خانەخوێبگەڕێ بۆ ناونیشانی ئای پی دوور لە بەکارهێنەران کە لاپەڕە گۆڕانکاریدەکەن. ئەگەر ڕاژەکاری دی ان ئەی سی خاو یان کارنەکردنت هەیە یان ئەم تایبەتمەندیەت نەوێت، ئەم هەڵبژاردنە لە کاربخە';
