...
$lang['_header_easywiki']      = 'EasyWiki 設定';
...
$lang['sneaky_index']          = '預設情況下，EasyWiki 會在索引頁會顯示所有分類名稱。啟用此選項，會隱藏使用者沒有閱讀權限的頁面，但也可能將他可以閱讀的子頁面一併隱藏。在特定 ACL 設定下，這可能導致索引無法使用。';
...
$lang['disableactions']        = '停用的 EasyWiki 動作';
...
$lang['updatecheck']           = '檢查更新與安全性警告？EasyWiki 需要聯繫 update.dokuwiki.org 才能使用此功能。';
...
$lang['renderer__core']        = '%s (easywiki 核心)';
$lang['renderer__plugin']      = '%s (附加元件)';
$lang['dnslookups']            = 'EasyWiki 將查詢使用者編輯頁面的遠程 IP 位址主機名稱。若您的 DNS 伺服器速度較慢、失效，或者您不想要此功能，请停用此選項';
...
$lang['userewrite_o_2']        = 'EasyWiki 內部控制';
