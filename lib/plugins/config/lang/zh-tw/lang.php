 ...
 */
$lang['menu']                  = '系統配置設定';
$lang['error']                 = '設定因為不合法的值而失敗，請檢查您的改變並重新送出。<br />
不正確的值會被紅色方框圍住。';
...
$lang['_msg_setting_undefined'] = '設置的資料定義不存在。';
...
$lang['title']                 = 'Wiki 標題';
$lang['template']              = '樣板';
$lang['license']               = '您的內容要使用哪個授權方式發布？';
$lang['fullpath']              = '顯示完整的路徑於頁面底部';
$lang['recent']                = '最近更新';
$lang['breadcrumbs']           = '顯示“足迹”的數量';
$lang['youarehere']            = '顯示“您在這裡”';
$lang['typography']            = '進行字符替換';
$lang['htmlok']                = '允許嵌入式HTML';
$lang['phpok']                 = '允許嵌入式PHP';
$lang['dformat']               = '日期格式（請見 PHP\'s <a href="http://www.php.net/strftime">strftime</a> 函式）';
$lang['signature']             = '簽名';
...
$lang['cachetime']             = 'cache 的最大時間（秒）';
$lang['locktime']              = '鎖定檔案的最大時間（秒）';
$lang['fetchsize']             = 'fetch.php 可以從外部下載的最大檔案大小（bytes）';
...
$lang['renderer_xhtml']        = '主要 Wiki 頁面（xhtml）輸出使用的方式';
...
$lang['target____interwiki']   = 'Wiki 內部連結的目標視窗';
...
$lang['ftp____port']           = 'Safemode Hack 的 FTP 連接埠';
$lang['ftp____user']           = 'Safemode Hack 的 FTP 使用者名稱';
$lang['ftp____pass']           = 'Safemode Hack 的 FTP 密碼';
$lang['ftp____root']           = 'Safemode Hack 的 FTP 根目錄';
$lang['license_o_']            = '尚未選擇';
$lang['typography_o_0']        = '無';
$lang['typography_o_1']        = '僅限用單引號';
...
$lang['showuseras_o_email']    = '電子信箱（會以 mailguard 模糊處理）';
$lang['showuseras_o_email_link'] = '顯示於 mailto: 連結的電子信箱';
$lang['useheading_o_0']        = '從不';
$lang['useheading_o_navigation'] = '只有導航內容';
