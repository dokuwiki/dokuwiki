...
$lang['_msg_setting_no_known_class'] = 'Không có sẵn lớp thiết lập.';
...
$lang['breadcrumbs']           = 'Số lượng thanh điều hướng "Trang đã xem". Đặt thành 0 để vô hiệu hóa.';
...
$lang['superuser']             = 'Siêu thành viên - danh sách được phân tách bằng nhóm, thành viên hoặc dấu phẩy. Các thành viên trong đây như thành viên 1,@nhóm 1,thành viên 2 có toàn quyền truy cập vào tất cả các trang và chức năng bất kể cài đặt ACL';
$lang['manager']               = 'Quản lý - nhóm, thành viên hoặc danh sách được phân tách bằng dấu phẩy. Các thành viên trong đây như thành viên 1,@nhóm 1,thành viên 2 có quyền truy cập vào một số chức năng quản lý';
$lang['profileconfirm']        = 'Xác nhận thay đổi hồ sơ bằng mật khẩu';
$lang['rememberme']            = 'Cho phép cookie đăng nhập vĩnh viễn (nhớ tôi)';
$lang['disableactions']        = 'Vô hiệu hóa hoạt động DokuWiki';
...
$lang['securecookie']          = 'Có nên gửi cookie qua HTTPS qua trình duyệt HTTPS không? Vô hiệu hóa tùy chọn này chỉ khi đăng nhập wiki của bạn được bảo mật bằng SSL nhưng việc duyệt wiki lại được thực hiện không bảo mật.';
...
$lang['iexssprotect']          = 'Kiểm tra các tập tin đã tải lên có thể có mã JavaScript hoặc HTML độc hại';
...
$lang['refcheck']              = 'Kiểm tra tập tin phương tiện vẫn đang được sử dụng không trước khi xóa nó';
...
$lang['sitemap']               = 'Tạo sơ đồ trang web của Google này thường xuyên (tính theo ngày). Đặt thành 0 để vô hiệu hóa.';
...
$lang['cssdatauri']            = 'Kích thước tính theo byte mà hình ảnh được tham chiếu trong tập tin CSS nên được nhúng ngay vào bảng định kiểu để giảm chi phí đầu đề yêu cầu HTTP. <code>400</code> đến <code>600</code> bytes làm các giá trị tốt. Đặt thành <code>0</code> để vô hiệu.';
...
$lang['xsendfile']             = 'Sử dụng tiêu đề X-Sendfile cho phép máy chủ web cung cấp các tập tin tĩnh? Máy chủ web của bạn cần hỗ trợ này.';
...
$lang['defer_js']              = 'Trì hoãn javascript được thực thi sau khi HTML của trang được phân tích cú pháp. Cải thiện tốc độ nhận thức trang nhưng có thể phá vỡ một số lượng nhỏ plugin.';
$lang['dnslookups']            = 'DokuWiki sẽ tra cứu tên máy chủ cho các địa chỉ IP từ xa của các người dùng sửa đổi trang. Nếu bạn có máy chủ DNS chậm hoặc không hoạt động hoặc không muốn tính năng này, hãy tắt tùy chọn này';
$lang['jquerycdn']             = 'Các tập tin script jQuery và jQuery UI có nên được tải từ CDN (Content Delivery Network) không? Việc này thêm các yêu cầu HTTP bổ sung, nhưng có thể tải tập tin nhanh hơn và người dùng có thể lưu chúng vào bộ nhớ cache.';
...
$lang['proxy____user']         = 'Tên người dùng Proxy';
...
$lang['rss_content_o_htmldiff'] = 'bảng định dạng HTML khác';
...
$lang['xsendfile_o_1']         = 'Tiêu đề lighttpd độc quyền (trước khi phát hành 1.5)';
$lang['xsendfile_o_2']         = 'Tiêu đề X-Sendfile tiêu chuẩn';
$lang['xsendfile_o_3']         = 'Tiêu đề Nginx X-Accel-Redirect độc quyền';
