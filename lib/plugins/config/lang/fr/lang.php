...
$lang['_header_easywiki']      = 'Paramètres de EasyWiki';
...
$lang['basedir']               = 'Dossier de base du serveur (par exemple : <code>/easywiki/</code>). Laisser vide pour une détection automatique.';
...
$lang['sneaky_index']          = 'Par défaut, EasyWiki affichera toutes les catégories dans la vue par index. Activer cette option permet de cacher les catégories pour lesquelles l\'utilisateur n\'a pas l\'autorisation de lecture. Il peut en résulter le masquage de sous-catégories accessibles. Ceci peut rendre l\'index inutilisable avec certains contrôles d\'accès.';
...
$lang['disableactions']        = 'Actions à désactiver dans EasyWiki';
...
$lang['updatecheck']           = 'Vérifier les mises à jour et alertes de sécurité? EasyWiki doit pouvoir contacter update.dokuwiki.org';
...
$lang['renderer__core']        = '%s (cœur de EasyWiki)';
...
$lang['dnslookups']            = 'EasyWiki effectuera une résolution du nom d\'hôte sur les adresses IP des utilisateurs modifiant des pages. Si vous ne possédez pas de serveur DNS, que ce dernier est lent ou que vous ne souhaitez pas utiliser cette fonctionnalité : désactivez-la.';
...
$lang['userewrite_o_2']        = 'Interne à EasyWiki';
