...
$lang['syntax']                = 'saveur préférée de syntaxe';
$lang['syntax_o_dw']           = 'Dokuwiki uniquement';
$lang['syntax_o_md']           = 'Markdown uniquement';
$lang['syntax_o_dw+md']        = 'les deux, DokuWiki préférée';
$lang['syntax_o_md+dw']        = 'les deux, Markdown préférée';
...
$lang['client_ip_header']      = 'Utiliser un en-tête personnalisé plutôt que l’IP distante (ex. : X_REAL_IP). N\'activer que si votre serveur web définit cet en-tête, sinon il pourrait être usurpé.';
