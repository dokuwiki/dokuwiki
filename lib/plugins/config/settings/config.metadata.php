...
$meta['passcrypt']   = ['multichoice', '_choices' => ['smd5', 'md5', 'apr1', 'sha1', 'ssha', 'lsmd5', 'crypt', 'mysql', 'my411', 'kmd5', 'pmd5', 'hmd5', 'mediawiki', 'bcrypt', 'djangomd5', 'djangosha1', 'djangopbkdf2_sha1', 'djangopbkdf2_sha256', 'sha512', 'argon2i', 'argon2id']];
$meta['defaultgroup']= ['string'];
$meta['superuser']   = ['string', '_caution' => 'danger'];
$meta['manager']     = ['string'];
$meta['profileconfirm'] = ['onoff'];
$meta['rememberme'] = ['onoff'];
$meta['disableactions'] = ['disableactions', '_choices' => ['backlink', 'index', 'recent', 'revisions', 'search', 'subscription', 'register', 'resendpwd', 'profile', 'profile_delete', 'edit', 'wikicode', 'check', 'rss'], '_combine' => ['subscription' => ['subscribe', 'unsubscribe'], 'wikicode' => ['source', 'export_raw']]];
