...
$lang['summary']               = 'Hiển thị thành viên %1$d-%2$d trong %3$d được tìm thấy. Tổng cộng là %4$d thành viên.';
$lang['nonefound']             = 'Không tìm thấy thành viên. Tổng cộng là %d thành viên.';
...
$lang['next']                  = 'sau';
$lang['last']                  = 'cuối';
$lang['edit_usermissing']      = 'Không tìm thấy thành viên đã chọn, tên thành viên được chỉ định có thể đã bị xóa hoặc đã được thay đổi ở nơi khác.';
...
$lang['note_pass']             = 'Mật khẩu sẽ được tạo tự động nếu trường bị bỏ trống và thông báo của thành viên được bật.';
...
$lang['addUser_error_create_event_failed'] = 'Một plugin ngăn không cho thành viên mới được thêm vào. Có thể xem lại các tin nhắn khác để biết thêm thông tin.';
