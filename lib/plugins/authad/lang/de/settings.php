...
$lang['sso_charset']           = 'Dies ist der Zeichensatz, in dem Ihr Webbrowser usernamen an Kerberos oder per NTLM überträgt. Wird dies leer gelassen, so wird UTF-8 oder latin-1 angenommen. Dies erfordert die iconv Erweiterung.';
