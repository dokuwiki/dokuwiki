...
$lang['sso']                   = 'Deve essere usato Single-Sign-On via Kerberos?';
$lang['sso_charset']           = 'Il set di caratteri che il tuo web server passera nel nome utente Kerberos. Lasciare vuoto per UTF-8 p latin-1. Richiesta estensione iconv. ';
