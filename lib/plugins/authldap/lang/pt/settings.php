...
$lang['binddn']                = 'DN de um utilizador de ligação opcional, quando a ligação é anónima não é suficiente. Ex. <code> cn = admin, dc = my, dc = home </code>';
$lang['bindpw']                = 'Senha do utilizador acima';
$lang['attributes']            = 'Atributos a serem recuperados com a pesquisa LDAP.';
$lang['userscope']             = 'Escopo de pesquisa limite para pesquisa de utilizador';
