...
class remote_plugin_acl extends DokuWiki_Remote_Plugin
{
    ...
    {
        return ['listAcls' => ['args' => [], 'return' => 'Array of ACLs {scope, user, permission}', 'name' => 'listAcls', 'doc' => 'Get the list of all ACLs'], 'addAcl' => ['args' => ['string', 'string', 'int'], 'return' => 'int', 'name' => 'addAcl', 'doc' => 'Adds a new ACL rule.'], 'delAcl' => ['args' => ['string', 'string'], 'return' => 'int', 'name' => 'delAcl', 'doc' => 'Delete an existing ACL rule.']];
    }
