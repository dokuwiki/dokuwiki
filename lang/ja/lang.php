...
$lang['Validation Exception Decimal needed'] = '数字のみ有効';
...
$lang['Validation Exception Media mime type'] = 'MIMEタイプ %s は %s の許可一覧と一致する必要があります';
...
$lang['Exception illegal option'] = 'この集約タイプでは、\'<code>%s</code>\' オプションは無効です';
...
$lang['admin_csvexport']       = '生データを CSV ファイルで出力する';
$lang['admin_csvimport']       = 'CSV ファイルから生データを入力する';
$lang['admin_csvdone']         = 'CSV ファイルを読み込んだ';
$lang['admin_csvhelp']         = 'フォーマットの詳細については、CSV 入力マニュアルを参照してください';
