...
$lang['menu_assignments']      = 'スキーマ割当て';
$lang['headline']              = '構造化データ';
$lang['edithl']                = '<i>%s</i> スキーマの編集';
...
$lang['Validation Exception Integer needed'] = '整数のみを許可します。';
$lang['Validation Exception Integer min'] = '%d 以上を許可します。';
$lang['Validation Exception Integer max'] = '%d 以下を許可します。';
