...
class utf8_unicode_test extends EasyWikiTest {

    function test_from_1byte(){
        $in  = 'a';
        $out = array(97);
        $this->assertEquals(\easywiki\Utf8\Unicode::fromUtf8($in),$out);
    }
    ...
    function test_to_1byte(){
        $out  = 'a';
        $in = array(97);
        $this->assertEquals(\easywiki\Utf8\Unicode::toUtf8($in),$out);
    }
