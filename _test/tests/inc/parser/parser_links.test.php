...
class TestOfDoku_Parser_Links extends TestOfDoku_Parser {
    ...
    function testMediaInternal() {
        ...
        $calls = array (
            ...
            array('p_open',array()),
            array('cdata',array("\n".'Foo ')),
            array('internalmedia',array('img.gif',NULL,NULL,NULL,NULL,'cache','details',array())),
            array('cdata',array(' Bar')),
            array('p_close',array()),
            array('document_end',array()),
        );
    ...
    function testMediaInternalLinkOnly() {
        ...
        $calls = array (
            ...
            array('p_open',array()),
            array('cdata',array("\n".'Foo ')),
            array('internalmedia',array('img.gif',NULL,NULL,NULL,NULL,'cache','linkonly',array())),
            array('cdata',array(' Bar')),
            array('p_close',array()),
            array('document_end',array()),
        );
    ...
    function testMediaNotImage() {
        ...
        $calls = array (
            ...
            array('p_open',array()),
            array('cdata',array("\n".'Foo ')),
            array('internalmedia',array('foo.txt','Some File',null,10,10,'cache','details',array())),
            array('cdata',array(' Bar')),
            array('p_close',array()),
            array('document_end',array()),
        );
    ...
    function testMediaInternalLAlign() {
        ...
        $calls = array (
            ...
            array('p_open',array()),
            array('cdata',array("\n".'Foo ')),
            array('internalmedia',array('img.gif',NULL,'left',NULL,NULL,'cache','details',array())),
            array('cdata',array(' Bar')),
            array('p_close',array()),
            array('document_end',array()),
        );
    ...
    function testMediaInternalRAlign() {
        ...
        $calls = array (
            ...
            array('p_open',array()),
            array('cdata',array("\n".'Foo ')),
            array('internalmedia',array('img.gif',NULL,'right',NULL,NULL,'cache','details',array())),
            array('cdata',array(' Bar')),
            array('p_close',array()),
            array('document_end',array()),
        );
    ...
    function testMediaInternalCenter() {
        ...
        $calls = array (
            ...
            array('p_open',array()),
            array('cdata',array("\n".'Foo ')),
            array('internalmedia',array('img.gif',NULL,'center',NULL,NULL,'cache','details',array())),
            array('cdata',array(' Bar')),
            array('p_close',array()),
            array('document_end',array()),
        );
    ...
    function testMediaInternalParams() {
        ...
        $calls = array (
            ...
            array('p_open',array()),
            array('cdata',array("\n".'Foo ')),
            array('internalmedia',array('img.gif',NULL,NULL,'50','100','nocache','details',array())),
            array('cdata',array(' Bar')),
            array('p_close',array()),
            array('document_end',array()),
        );
    ...
    function testMediaInternalTitle() {
        ...
        $calls = array (
            ...
            array('p_open',array()),
            array('cdata',array("\n".'Foo ')),
            array('internalmedia',array('img.gif','Some Image',NULL,'50','100','cache','details',array())),
            array('cdata',array(' Bar')),
            array('p_close',array()),
            array('document_end',array()),
        );
    ...
    function testMediaExternal() {
        ...
        $calls = array (
            ...
            array('p_open',array()),
            array('cdata',array("\n".'Foo ')),
            array('externalmedia',array('http://www.google.com/img.gif',NULL,NULL,NULL,NULL,'cache','details',array())),
            array('cdata',array(' Bar')),
            array('p_close',array()),
            array('document_end',array()),
        );
    ...
    function testMediaExternalParams() {
        ...
        $calls = array (
            ...
            array('p_open',array()),
            array('cdata',array("\n".'Foo ')),
            array('externalmedia',array('http://www.google.com/img.gif',NULL,NULL,'50','100','nocache','details',array())),
            array('cdata',array(' Bar')),
            array('p_close',array()),
            array('document_end',array()),
        );
    ...
    function testMediaExternalTitle() {
        ...
        $calls = array (
            ...
            array('cdata',array("\n".'Foo ')),
            array('externalmedia',
            array('http://www.google.com/img.gif','Some Image',NULL,'50','100','cache','details',array())),
            array('cdata',array(' Bar')),
            array('p_close',array()),
            array('document_end',array()),
        );
    ...
    function testNestedMedia() {
        ...
        $calls = array (
            ...
            array('cdata',array("\n".'Foo ')),
            array('internalmedia',
            array('img.gif','{{foo.gif|{{bar.gif|Bar',NULL,NULL,NULL,'cache','details',array())),
            array('cdata',array('}}}} Bar')),
            array('p_close',array()),
            array('document_end',array()),
        );
