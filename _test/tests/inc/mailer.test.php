 ...
 * @group mailer_class
 */
class mailer_test extends EasyWikiTest {
    ...
    function test_simplemail(){
        ...
        // construct the expected mail body text - include the expected easywiki signature
    ...
    function test_replacements(){
        ...
        $replacements = array( '@DATE@','@BROWSER@','@IPADDRESS@','@HOSTNAME@','@EMAILSIGNATURE@',
                               '@TITLE@','@EASYWIKIURL@','@USER@','@NAME@','@MAIL@');
    ...
    function test_simplemailsignature() {
        ...
        $mailbody = 'A test mail in ASCII';
        $signature = "\n-- \n" . 'This mail was generated by EasyWiki at' . "\n" . WIKI_URL . "\n";
        $mail = new TestMailer();
        $mail->to('test@example.com');
        $mail->setBody($mailbody);
...
<br /><hr />
<small>This mail was generated by EasyWiki at<br /><a href="' . WIKI_URL . '">' . WIKI_URL . '</a></small>
</body>
</html>
';
