...
class Doku_Action_Search extends Doku_Action
{
    ...
    /**
     * The Doku_Action interface to specify the required permission to
     * search
     * 
    ...
    /**
     * The Doku_Action interface to handle the search event
     * 
    ...
    /**
     * the Doku_Action interface that returns the html for displaying
     * search results.
