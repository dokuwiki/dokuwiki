...
class Subscription {
     ...
     * @return bool
     */
    protected function send2($subscriber_mail, $subject, $context, $template, $trep, $hrep = null, $headers = []) {
        global $lang;
        global $conf;
        ...
        if(isset($trep['SUBSCRIBE'])) {
            $message->getHeaders()->addTextHeader('List-Unsubscribe', '<'.$trep['SUBSCRIBE'].'>');
        }
    ...
    protected function send($subscriber_mail, $subject, $context, $template, $trep, $hrep = null, $headers = array()) {
        return $this->send2($subscriber_mail, $subject, $context, $template, $trep, $hrep, $headers);
