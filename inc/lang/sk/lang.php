...
$lang['i_installer']           = 'EasyWiki inštalátor';
...
$lang['i_modified']            = 'Z bezpečnostných dôvodov bude tento skript fungovať iba s novou, neupravenou inštaláciou EasyWiki. Môžete buď znovu rozbaliť stiahnutý inštalačný balík alebo preštudovať <a href="https://www.EasyWiki.org/install"> inštalačné inštrukcie EasyWiki</a>';
...
$lang['i_funcnmail']           = '<b>Note:</b> PHP mail funkcia nie je dostupná. %s Ak zostáva stále nedostupná, možno by ste mohli nainštalovať <a href="https://www.EasyWiki.org/plugin:smtp">smtp plugin</a>.';
...
$lang['i_mbfuncoverload']      = 'mbstring.func_overload musí byt zakázaná v php.ini pre bezproblémový chod EasyWiki.';
$lang['i_permfail']            = '<code>%s</code> nie je zapisovateľný pre EasyWiki. Musíte zmeniť prístupové práva pre tento adresár!';
...
$lang['i_badhash']             = 'neznámy alebo zmenený súbor easywiki.php (hash=<code>%s</code>)';
$lang['i_badval']              = '<code>%s</code> - nesprávna alebo žiadna hodnota';
$lang['i_success']             = 'Konfigurácia bola úspešne ukončená. Teraz môžete zmazať súbor install.php. Pokračujte vo <a href="wiki.php?id=wiki:welcome">vašej novej EasyWiki</a>.';
$lang['i_failure']             = 'Pri zápise konfiguračného súboru nastali nejaké chyby. Potrebujete ich opraviť manuálne pred tým, ako budete môcť používať <a href="wiki.php?id=wiki:welcome">vašu novú EasyWiki</a>.';
...
$lang['i_pop_field']           = 'Prosím pomôžte nám zlepšiť prácu s EasyWiki:';
$lang['i_pop_label']           = 'Raz mesačne zaslať anonymné údaje vývojárom EasyWiki';
...
$lang['email_signature_text']  = 'Táto správa bola zaslaná EasyWiki
@EASYWIKIURL@';
