...
$lang['noDatabase']      = "MySQL: Nie je možné vstúpiť do databázy '%d'. Prosím informujte  správcu tohto systému.";
$lang['noConnect']       = "MySQL: Nie je možné pripojiť sa k '%u@%s'. Prosím informujte  správcu tohto systému.";
