...
$lang['regpwmail']             = 'A sua senha do EasyWiki';
...
$lang['i_permfail']            = 'O EasyWiki não tem permissão de escrita em <code>%s</code>. Você precisa corrigir as configurações de permissão nesse diretório!';
...
$lang['i_badhash']             = 'easywiki.php não reconhecido ou modificado (hash=<code>%s</code>)';
$lang['i_badval']              = '<code>%s</code> - valor ilegal ou em branco';
$lang['i_success']             = 'A configuração terminou com sucesso. Agora você deve excluir o arquivo install.php. Conheça o seu <a href="wiki.php?id=wiki:welcome">novo EasyWiki</a>!';
$lang['i_failure']             = 'Ocorreram alguns erros durante a escrita dos arquivos de configuração. É necessário corrigi-los manualmente antes de usar seu <a href="wiki.php?id=wiki:welcome">novo EasyWiki</a>';
...
$lang['i_pop_field']           = 'Por favor, nos ajude a melhorar sua experiência com EasyWiki:';
$lang['i_pop_label']           = 'Uma vez por mês, enviar anonimamente informações de uso de dados para os desenvolvedores EasyWiki';
...
$lang['email_signature_text']  = 'Essa mensagem foi gerada pelo EasyWiki em
@EASYWIKIURL@';
