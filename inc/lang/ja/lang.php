...
$lang['searchcreatepage']      = 'お探しの内容が見つからなかった場合は、検索ワードに因んだ名前の %s というページを作成・編集出来ます。';
$lang['search_fullresults']    = '全文検索';
$lang['js']['search_toggle_tools'] = '検索ツールを切り替える';
...
$lang['search_starts_with']    = '検索ワードで始まる';
$lang['search_ends_with']      = '検索ワードで終わる';
...
$lang['search_past_month']     = '1ヶ月以内';
$lang['search_past_year']      = '1年以内';
$lang['search_sort_by_hits']   = 'ヒット数順に並べる';
$lang['search_sort_by_mtime']  = '最終更新日時順に並べる';
