...
$lang['profconfdelete']        = 'このWikiから自分のアカウントを消去出来ます。<br/> この操作は取消すことができません。';
...
$lang['resendpwdbadauth']      = '申し訳ありませんが、この確認コードは有効ではありません。URLが一部切り取られていないかどうか、メール内に記載されたリンクをご確認下さい。';
