...
$lang['draftdate']             = 'Bản nháp được lưu tự động vào lúc';
...
$lang['js']['hidedetails']     = 'Ẩn chi tiết';
...
$lang['js']['restore_confirm'] = 'Muốn phục hồi phiên bản này?';
...
$lang['js']['media_overwrt']   = 'Ghi đè lên các tập tin hiện có';
...
$lang['pwdforget']             = 'Bạn quên mật khẩu? Nhận một cái mới';
...
$lang['uploadfail']            = 'Tải lên không thành công. Có thể không đúng quyền?';
...
$lang['authtempfail']          = 'Xác thực thành viên tạm thời không có sẵn. Nếu tình trạng này vẫn còn, xin hãy thông báo cho Quản trị viên Wiki của bạn.';
...
$lang['i_funcnmail']           = '<b>Chú ý:</b> Không có sẵn hàm PHP mail. %s Nếu nó vẫn không có sẵn, bạn có thể cài đặt <a href="http://dokuwiki.org/plugins/smtp">smtp plugin</a>.';
...
$lang['i_urandom']             = 'DokuWiki không thể tạo số mật mã học an toàn cho cookie. Bạn có thể muốn kiểm tra cài đặt open_basingir trong php.ini để truy cập <code>/dev/urandom</code> thích hợp.';
...
$lang['i_success']             = 'Đã hoàn thành việc cấu hình thành công. Bạn có thể xóa tập tin install.php ngay bây giờ. Tiếp tục
                                 <a href="doku.php?id=wiki:welcome">DokuWiki mới của bạn</a>';
$lang['i_failure']             = 'Một số lỗi xảy ra trong khi viết các tập tin cấu hình. Bạn có thể cần phải sửa chúng thủ công trước khi
                                  bạn có thể sử dụng <a href="doku.php?id=wiki:welcome">DokuWiki mới của bạn</a>.';
$lang['i_policy']              = 'Chính sách ACL ban đầu';
$lang['i_pol0']                = 'Wiki mở (bất kỳ ai cũng có thể đọc, viết, tải lên)';
$lang['i_pol1']                = 'Wiki công cộng (bất kỳ ai cũng có thể đọc, thành viên đã đăng ký có thể viết và tải lên)';
...
$lang['media_acl_warning']     = 'Danh sách này có thể không đầy đủ do các hạn chế ACL và các trang ẩn.';
$lang['email_fail']            = 'Thiếu hoặc đã vô hiệu PHP mail(). Các thư điện tử sau không được gửi:';
...
$lang['page_nonexist_rev']     = 'Trang không tồn tại ở %s. Sau đó, nó đã được tạo ở <a href="%s">%s</a>.';
