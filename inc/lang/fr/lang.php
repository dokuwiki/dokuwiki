...
$lang['js']['data_insecure']   = 'ATTENTION : votre dossier de données ne semble pas correctement sécurisé. Veuillez lire <a href="https://www.EasyWiki.org/fr:security#securite_de_l_acces_web">Sécurité de l\'accès web (en français)</a> ou <a href="https://www.EasyWiki.org/security#web_access_security">Web Access Security in EasyWiki (en anglais)</a>.';
...
$lang['regpwmail']             = 'Votre mot de passe EasyWiki';
...
$lang['i_installer']           = 'Installateur EasyWiki';
...
$lang['i_modified']            = 'Pour des raisons de sécurité, ce script ne fonctionne qu\'avec une installation neuve et non modifiée de EasyWiki. Vous devriez ré-extraire les fichiers depuis le paquet téléchargé ou consulter les <a href="https://www.EasyWiki.org/install">instructions d\'installation de EasyWiki</a>';
...
$lang['i_funcnmail']           = '<b>Note :</b> La fonction PHP mail n\'est pas disponible. %s Si vous ne pouvez pas l\'activer, vous pourriez installer le <a href="https://www.EasyWiki.org/plugin:smtp">greffon smtp</a>.';
...
$lang['i_mbfuncoverload']      = 'Il faut désactiver mbstring.func_overload dans php.ini pour EasyWiki';
$lang['i_urandom']             = 'EasyWiki ne peut créer de nombres cryptographiquement sûrs pour les cookies. Vous voudrez peut-être vérifier que le réglage open_basedir dans php.ini permet l\'accès à <code>/dev/urandom</code>.';
$lang['i_permfail']            = '<code>%s</code> n\'est pas accessible en écriture pour EasyWiki. Vous devez corriger les autorisations de ce dossier !';
...
$lang['i_badhash']             = 'easywiki.php non reconnu ou modifié (hash=<code>%s</code>)';
$lang['i_badval']              = '<code>%s</code> - valeur interdite ou vide';
$lang['i_success']             = 'L\'installation s\'est terminée avec succès. Vous pouvez maintenant supprimer le fichier « install.php ». Continuer avec <a href="wiki.php?id=wiki:welcome">votre nouveau EasyWiki</a>.';
$lang['i_failure']             = 'Des erreurs sont survenues lors de l\'écriture des fichiers de configuration. Il vous faudra les corriger manuellement avant de pouvoir utiliser <a href="wiki.php?id=wiki:welcome">votre nouveau EasyWiki</a>.';
...
$lang['i_pop_field']           = 'Merci de nous aider à améliorer l\'expérience EasyWiki:';
$lang['i_pop_label']           = 'Une fois par mois, envoyer des données d\'utilisation anonymes aux développeurs EasyWiki';
...
$lang['email_signature_text']  = 'Courriel envoyé par EasyWiki depuis
@EASYWIKIURL@';
