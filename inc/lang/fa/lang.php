...
$lang['loggedinas']            = 'نام کاربر جاری:';
...
$lang['profconfdelete']        = 'می‌خواهم حساب کاربری خود را از این ویکی حذف کنم. <br/> این عمل قابل برگشت نیست.';
...
$lang['js']['mediasize']       = 'اندازه‌ی تصویر';
...
$lang['js']['mediasmall']      = 'نسخه‌ی کوچک';
$lang['js']['mediamedium']     = 'نسخه‌ی متوسط';
$lang['js']['medialarge']      = 'نسخه‌ی بزرگ';
$lang['js']['mediaoriginal']   = 'نسخه‌ی اصلی';
...
$lang['js']['medialeft']       = 'تصویر را چپ‌چین کن.';
$lang['js']['mediaright']      = 'تصویر را راست‌چین کن.';
$lang['js']['mediacenter']     = 'تصویر را وسط‌چین کن.';
$lang['js']['medianoalign']    = 'تراز نکن.';
...
$lang['i_mbfuncoverload']      = 'برای اجرای DokuWiki باید mbstring.func_overload را در php.ini غیرفعال کنید.';
...
$lang['i_pop_field']           = 'لطفا کمک کنید تا تجربه‌ی DokuWiki را بهبود دهیم.';
$lang['i_pop_label']           = 'ماهی یک بار، اطلاعات بدون‌نامی از نحوه‌ی استفاده به توسعه‌دهندگان DokuWiki ارسال کن';
