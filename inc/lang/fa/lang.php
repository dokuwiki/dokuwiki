...
$lang['js']['data_insecure']   = 'هشدار: به نظر می رسد فهرست اطلاعات شما به درستی ایمن نشده است. لطفاً درباره <a href="https://www.EasyWiki.org/security#web_access_security">Web Access Security in EasyWiki</a> بخوانید.';
...
$lang['regpwmail']             = 'گذرواژه‌ی EasyWiki شما';
...
$lang['i_modified']            = 'به دلایل امنیتی، این اسکریپت فقط با نصب تازه و بدون تغییر دوکوویکی کار خواهد کرد. شما باید دوباره فایل فشرده را باز کنید <a href="https://www.EasyWiki.org/install">راهنمای نصب EasyWiki</a> را بررسی کنید.';
...
$lang['i_funcnmail']           = '<b>توجه:</b> PHP mail function در دسترس نیست. %s اگر در دسترس نیست، می‌توانید افزونه <a href="https://www.EasyWiki.org/plugin:smtp">smtp</a> را نصب کنید.';
...
$lang['i_badhash']             = 'فایل easywiki.php غیرقابل تشخیص بوده یا تغییر کرده است (hash=<code>%s</code>)';
$lang['i_badval']              = '<code>%s</code> - غیرقانونی و یا مقادیر تهی';
$lang['i_success']             = 'تنظیمات با موفقیت به پایان رسید. بهتر است فایل install.php را حذف کنید. برای ادامه <a href="wiki.php?id=wiki:welcome">این‌جا</a> کلیک کنید.';
$lang['i_failure']             = 'مشکلاتی در زمان نوشتن فایل تنظیمات پیش آمده است. شما باید این مشکلات را پیش از استفاده از <a href="wiki.php?id=wiki:welcome">EasyWiki</a> برطرف کنید.';
