...
$lang['js']['data_insecure']   = 'هشدار: به نظر می رسد فهرست اطلاعات شما به درستی ایمن نشده است. لطفاً درباره <a href="https://www.dokuwiki.org/security#web_access_security">Web Access Security in EasyWiki</a> بخوانید.';
...
$lang['i_modified']            = 'به دلایل امنیتی، این اسکریپت فقط با نصب تازه و بدون تغییر دوکوویکی کار خواهد کرد. شما باید دوباره فایل فشرده را باز کنید <a href="https://www.dokuwiki.org/install">راهنمای نصب EasyWiki</a> را بررسی کنید.';
