...
$lang['js']['data_insecure']   = 'ATTENZIONE: sembra che la cartella "data" non sia adeguatamente protetta. Vedi <a href="https://www.EasyWiki.org/security#web_access_security">Sicurezza Accesso Web in EasyWiki</a>.';
...
$lang['regpwmail']             = 'La tua password per EasyWiki';
...
$lang['i_installer']           = 'Installazione di EasyWiki';
...
$lang['i_modified']            = 'Per motivi di sicurezza questa procedura funziona solamente con un\'installazione EasyWiki nuova e non modificata.
Prova a estrarre di nuovo i file dal pacchetto scaricato oppure consulta le
<a href="https://www.EasyWiki.org/install">istruzioni per l\'installazione di EasyWiki</a>';
...
$lang['i_funcnmail']           = '<b>Nota:</b> La funzione mail PHP non è disponibile. %s Se rimane non disponibile, puoi provare ad installare <a href="https://www.EasyWiki.org/plugin:smtp">smtp plugin</a>.';
...
$lang['i_mbfuncoverload']      = 'mbstring.func_overload deve essere disabilitato in php.ini per eseguire EasyWiki.';
$lang['i_urandom']             = 'EasyWiki non può creare un numero crittograficamente sicuro di cookies. Puoi provare a controllare sulle impostazioni open_basedir su php.ini per un corretto <code>/dev/urandom</code> accesso.';
$lang['i_permfail']            = 'EasyWiki non può scrivere <code>%s</code>. E\' necessario correggere i permessi per questa directory!';
...
$lang['i_badhash']             = 'easywiki.php (hash=<code>%s</code>) non riconosciuto o modificato';
$lang['i_badval']              = '<code>%s</code> - valore vuoto o non valido';
$lang['i_success']             = 'La configurazione è stata completata correttamente. Ora è possibile eliminare il file install.php. Poi, visita <a href="wiki.php?id=wiki:welcome">il tuo nuovo EasyWiki</a>.';
$lang['i_failure']             = 'Si sono verificati errori durante la scrittura dei file di configurazione. Potrebbe essere necessario correggerli manualmente prima di poter utilizzare <a href="wiki.php?id=wiki:welcome">il tuo nuovo EasyWiki</a>.';
...
$lang['i_pop_field']           = 'Per favore, aiutaci ad incrementare la conoscenza di EasyWiki:';
$lang['i_pop_label']           = 'Mensilmente invia una statistica d\'uso anonima di EasyWiki agli sviluppatori';
...
$lang['email_signature_text']  = 'Questa email è stata generata dal EasyWiki all\'indirizzo
@EASYWIKIURL@';
