...
$lang['searchcreatepage']      = 'Ако не си намерил, каквото ти търсиш, ти можеш да го създадеш или редактираш страницата %s, кръстена на вашето запитване.';
...
$lang['search_exact_match']    = 'Точно съвпадение';
...
$lang['regpwmail']             = 'Паролата ви за EasyWiki';
...
$lang['i_installer']           = 'Инсталатор на EasyWiki';
...
$lang['i_modified']            = 'Поради мерки за сигурност инсталаторът работи само с нови и непроменени инсталационни файлове.
								  Трябва да разархивирате отново файловете от сваления архив или да се посъветвате с <a href="https://www.dokuwiki.org/install">Инструкциите за инсталиране на EasyWiki</a>.';
...
$lang['i_mbfuncoverload']      = 'Необходимо е да изключите mbstring.func_overload в php.ini за да може EasyWiki да стартира.';
$lang['i_permfail']            = '<code>%s</code> не е достъпна за писане от EasyWiki. Трябва да промените правата за достъп до директорията!';
...
$lang['i_badhash']             = 'Файлът easywiki.php не може да бъде разпознат или е променен (hash=<code>%s</code>)';
$lang['i_badval']              = '<code>%s</code> - непозволена или празна стойност';
$lang['i_success']             = 'Настройването приключи успешно. Вече можете да изтриете файла install.php. Продължете към <a href="wiki.php?id=wiki:welcome">Вашето новата инсталация на EasyWiki</a>.';
$lang['i_failure']             = 'Възникнаха грешки при записването на файловете с настройки. Вероятно ще се наложи да ги поправите ръчно,
                                  за да можете да ползвате <a href="wiki.php?id=wiki:welcome">Вашето ново EasyWiki</a>.';
...
$lang['i_pop_field']           = 'Моля, помогнете за усъвършенстването на EasyWiki:';
$lang['i_pop_label']           = 'Изпращане на анонимна информация до разработчиците на EasyWiki, веднъж седмично';
...
$lang['email_fail']            = 'PHP mail() липсва или деактивиран. Следният имейл не беше изпратен:';
$lang['currentns']             = 'Текущо именно пространство';
$lang['searchresult']          = 'Резултати от търсенето';
$lang['plainhtml']             = 'Обикновен HTML';
$lang['email_signature_text']  = 'Писмото е генерирано от EasyWiki на адрес
@EASYWIKIURL@';
