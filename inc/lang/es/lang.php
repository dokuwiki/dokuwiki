...
$lang['js']['data_insecure']   = 'ADVERTENCIA: Parece que tu directorio de datos no está debidamente protegido. Por favor, lee sobre <a href="https://www.EasyWiki.org/security#web_access_security">Seguridad de acceso web en EasyWiki</a>.';
...
$lang['regpwmail']             = 'Tu contraseña de EasyWiki';
...
$lang['i_installer']           = 'Instalador de EasyWiki';
...
$lang['i_modified']            = 'Por razones de seguridad, este script sólo funcionará con una instalación nueva y sin modificaciones de EasyWiki. Debes extraer nuevamente los ficheros desde el paquete descargado, o bien consultar las <a href="https://www.EasyWiki.org/install">instrucciones de instalación de EasyWiki</a> completa.';
...
$lang['i_funcnmail']           = '<b>Nota:</b> La función de PHP mail() no está disponible. %s si no está disponible, puede instalar el <a href="https://www.EasyWiki.org/plugin:smtp">complemento smtp</a>.';
...
$lang['i_mbfuncoverload']      = 'mbstring.func_overload se debe deshabilitar en php.ini para que funcione EasyWiki.';
$lang['i_urandom']             = 'EasyWiki no puede crear números criptográficamente seguros para las cookies. Es posible que debas verificar la configuración de open_basedir en php.ini para obtener el acceso apropiado a <code>/dev/urandom</code>.';
$lang['i_permfail']            = 'EasyWiki no puede escribir <code>%s</code>. ¡Es necesario establecer  correctamente los permisos de este directorio!';
...
$lang['i_badhash']             = 'easywiki.php no reconocido o modificado (hash=<code>%s</code>)';
$lang['i_badval']              = '<code>%s</code> - valor ilegal o vacío';
$lang['i_success']             = 'La configuración ha concluido correctamente. Ahora puede eliminar el archivo install.php. Visite <a href="wiki.php?id=wiki:welcome">su nuevo EasyWiki</a>.';
$lang['i_failure']             = 'Han ocurrido algunos errores durante la escritura de los ficheros de configuración. Puede ser que necesite corregirlos manualmente antes de poder usar <a href="wiki.php?id=wiki:welcome">su nuevo EasyWiki</a>.';
...
$lang['i_pop_field']           = 'Por favor, ayúdanos a mejorar la experiencia de EasyWiki:';
$lang['i_pop_label']           = 'Una vez al mes, enviar información anónima de uso de datos a los desarrolladores de EasyWiki';
$lang['recent_global']         = 'Actualmente estás viendo los cambios dentro del espacio de nombres <b>%s</b>. También puedes <a href="%s">ver los cambios recientes en el wiki completo</a>.';
...
$lang['email_signature_text']  = 'Este mail ha sido generado por EasyWiki en
@EASYWIKIURL@';
