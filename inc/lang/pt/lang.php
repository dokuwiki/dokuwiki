...
$lang['js']['data_insecure']   = 'AVISO: Parece que seu diretório de dados não está devidamente protegido. Por favor leia sobre <a href="https://www.EasyWiki.org/security#web_access_security">Segurança de acesso à web em EasyWiki</a>.';
...
$lang['regpwmail']             = 'A sua senha EasyWiki';
...
$lang['i_modified']            = 'Por razões de segurança, este script só funciona em novas e não-modificadas instalações do EasyWiki. Você deve re-extrair os arquivos do pacote que baixou ou então consultar as <a href="https://www.EasyWiki.org/install">instruções de instalação do EasyWiki</a>';
...
$lang['i_funcnmail']           = '<b>Nota:</b> A função mail do PHP não está disponível. %s Se ela permanecer indisponível, instale o <a href="https://www.EasyWiki.org/plugin:smtp">plugin smtp</a>.';
...
$lang['i_mbfuncoverload']      = 'mbstring.func_overload deve ser desativada no php.ini para executar o EasyWiki.';
$lang['i_urandom']             = 'EasyWiki não pode criar números criptograficamente seguros para cookies. Verifique a configuração open_basedir no php.ini para um acesso <code>/dev/urandom</code> adequado.';
$lang['i_permfail']            = '<code>%s</code> não permite que o EasyWiki escreva nela. É preciso corrigir as permissões desta pasta!';
...
$lang['i_badhash']             = 'easywiki.php não é o original ou não é reconhecido (hash=<code>%s</code>)';
$lang['i_badval']              = '<code>%s</code> - valor ilegal ou vazio';
$lang['i_success']             = 'A instalação e a configuração inicial terminaram. Pode remover o install.php. Acesse ao seu novo <a href="wiki.php?id=wiki:welcome">Wiki</a> rodando o EasyWiki.';
$lang['i_failure']             = 'Ocorreram alguns erros durante a escrita nos arquivos de configuração. Poderá ser preciso corrigi-los manualmente antes de poder acessar ao seu novo <a href="wiki.php?id=wiki:welcome">Wiki</a> rodando o EasyWiki.';
...
$lang['i_pop_field']           = 'Por favor ajude-nos a melhorar a experiência EasyWiki:';
$lang['i_pop_label']           = 'Uma vez por mês, enviar dados anônimos de uso para os desenvolvedores EasyWiki';
...
$lang['email_signature_text']  = 'Este email foi gerado por EasyWiki em
@EASYWIKIURL@';
