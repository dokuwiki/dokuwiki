...
$lang['profna']                = 'Este wiki no li permet modificar el seu perfil';
...
$lang['resendpwdbadauth']      = 'Disculpe, pero este còdic d\'autenticació no es vàlit. Comprove si ha utilisat el víncul de confirmació sancer.';
...
$lang['licenseok']             = 'Nota: editant esta pàgina accepta llicenciar el seu contingut baix la següent llicència:';
...
$lang['mediainuse']            = 'L\'archiu "%s" no s\'ha borrat - encara s\'utilisant.';
...
$lang['js']['nosmblinks']      = 'Els vínculs a recursos compartits de Windows només funcionen en Microsoft Internet Explorer. No obstant, és poden copiar i apegar.';
...
$lang['mediaroot']             = 'base';
$lang['mediaupload']           = 'Enviar un archiu a l\'espai de noms actual. Per a crear sub-espais, afigga\'ls davant del nom de l\'archiu que pose en "Enviar com" separats per dos punts.';
...
$lang['qb_alert']              = 'Per favor, introduïxca el text que vullga formatejar.\nS\'afegirà al final del document.';
...
$lang['subscribe_noaddress']   = 'No hi ha cap direcció associada a la seua sessió, no es pot subscriure';
...
$lang['i_modified']            = 'Per raons de seguritat, este script només funcionarà en una instalació nova i verge de DokuWiki.
...
$lang['i_funcna']              = 'La funcio de PHP <code>%s</code> no està disponible. ¿Pot ser que el seu proveïdor d\'hostage l\'haja desactivada per algun motiu?';
...
$lang['i_success']             = 'La configuració ha finalisat correctament. Ya pot borrar l\'archiu install.php. Vaja al
<a href="doku.php">seu nou DokuWiki</a>.';
$lang['i_failure']             = 'Han aparegut alguns erros escrivint els archius de configuració. Deurà arreglar-los manualment ans que
puga utilisar el <a href="doku.php">seu nou DokuWiki</a>.';
