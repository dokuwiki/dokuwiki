...
$lang['regpwmail']             = 'EasyWiki parolanız';
...
$lang['i_installer']           = 'EasyWiki Kurulum Sihirbazı';
...
$lang['i_mbfuncoverload']      = 'EasyWiki\'nin çalışması için php.ini dosyasında mbstring.func_overload seçeneği kapalı (değeri 0) olarak ayarlanmalıdır.';
$lang['i_permfail']            = '<code>%s</code> EasyWiki tarafından yazılabilir değil. İzin ayarlarını bu klasör için düzeltmeniz gerekmektedir!';
...
$lang['i_badhash']             = 'easywiki.php tanınamadı ya da değiştirilmiş (hash=<code>%s</code>)';
$lang['i_badval']              = '<code>%s</code> - Yanlış veya boş değer';
$lang['i_success']             = 'Kurulum başarıyla tamamlandı. Şimdi install.php dosyasını silebilirsiniz. <a href="wiki.php?id=wiki:welcome">Yeni EasyWikiniz</a>i kullanabilirsiniz.';
$lang['i_failure']             = 'Ayar dosyalarını yazarken bazı hatalar oluştu. <a href="wiki.php?id=wiki:welcome">Yeni EasyWikiniz</a>i kullanmadan önce bu hatalarınızı elle düzeltmeniz gerekebilir.';
...
$lang['i_pop_field']           = 'Lütfen EasyWiki deneyimini geliştirmemizde, bize yardım edin:';
$lang['i_pop_label']           = 'EasyWiki geliştiricilerine ayda bir, anonim kullanım bilgisini gönder';
...
$lang['email_signature_text']  = 'Bu e-posta aşağıdaki EasyWiki tarafından otomatik olarak oluşturulmuştur
@EASYWIKIURL@';
