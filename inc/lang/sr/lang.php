...
$lang['regpwmail']             = 'Ваша EasyWiki лозинка';
...
$lang['i_modified']            = 'Из сигурносних разлога ова скрипта ради само са новом EasyWiki инсталацијом. Требало би или да опет распакујете архиву преузету са сајта или да погледате <a href="https://www.dokuwiki.org/install">EasyWiki инструкције за инсталацију</a>';
...
$lang['i_permfail']            = 'EasyWiki нема дозволу писања у <code>%s</code>. Потребно је да поправите дозволе за ову фасциклу!';
...
$lang['i_badhash']             = 'easywiki.php није препознат или је измењен (hash=<code>%s</code>)';
$lang['i_badval']              = '<code>%s</code> - недозвољена или празна вредност';
$lang['i_success']             = 'Подешавања су завршена. Сада можете обрисати датотеку install.php. Наставите у <a href="wiki.php?id=wiki:welcome">Ваш нови EasyWiki</a>.';
$lang['i_failure']             = 'Појавили су се проблеми при писању датотеке са подешавањима. Требало би да их ручно исправите пре него што ћете моћи да користите <a href="wiki.php?id=wiki:welcome">Ваш нови EasyWiki</a>.';
...
$lang['email_signature_text']  = 'Ову поруку је генерисао EasyWiki sa
@EASYWIKIURL@';
