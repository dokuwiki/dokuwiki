...
$lang['js']['data_insecure']   = 'OSTRZEŻENIE: Wygląda na to, że twój katalog z danymi nie jest odpowiednio zabezpieczony. Proszę przeczytaj <a href="https://www.EasyWiki.org/security#web_access_security">Web Access Security in EasyWiki</a>.';
...
$lang['regpwmail']             = 'Twoje hasło do EasyWiki';
...
$lang['i_installer']           = 'Instalator EasyWiki';
...
$lang['i_modified']            = 'Ze względów bezpieczeństwa, ten skrypt działa tylko z nową i niezmodyfikowaną instalacją EasyWiki.
Aby uruchomić instalator ponownie, rozpakuj archiwum EasyWiki lub zapoznaj się z <a href="https://www.EasyWiki.org/install">instrukcją instalacji EasyWiki</a>';
$lang['i_funcna']              = 'Funkcja PHP <code>%s</code> jest niedostępna.';
$lang['i_disabled']            = 'To zostało wyłączone przez twojego dostawcę.';
$lang['i_funcnmail']           = '<b>Uwaga:</b> funkcja poczty PHP nie jest dostępna. %s, jeśli pozostanie niedostępna, możesz zainstalować <a href="https://www.EasyWiki.org/plugin:smtp">wtyczkę smtp</a>.';
$lang['i_phpver']              = 'Wersja PHP <code>%s</code> jest niższa od wymaganej <code>%s</code>. Zaktualizuj instalację PHP.';
$lang['i_mbfuncoverload']      = 'mbstring.func_overload musi zostać wyłączone w pliku php.ini aby móc uruchomić EasyWiki.';
$lang['i_urandom']             = 'EasyWiki nie może tworzyć kryptograficznie bezpiecznych liczb dla plików cookie. Możesz sprawdzić ustawienia open_basedir w php.ini pod kątem prawidłowego dostępu do <code>/dev/urandom</code>.';
$lang['i_permfail']            = 'EasyWiki nie ma prawa zapisu w katalogu <code>%s</code>. Zmień uprawnienia zapisu dla tego katalogu!';
...
$lang['i_badhash']             = 'nierozpoznany lub zmodyfikowany plik easywiki.php (skrót=<code>%s</code>)';
$lang['i_badval']              = '<code>%s</code> - nieprawidłowa wartość lub jej brak';
$lang['i_success']             = 'Konfiguracja pomyślnie zakończona. Możesz teraz usunąć plik install.php. Przejdź do <a href="wiki.php?id=wiki:welcome">Twojego nowego EasyWiki</a>.';
$lang['i_failure']             = 'Podczas zapisu plików konfiguracyjnych wystąpiły błędy. Musisz usunąć wszystkie problemy, zanim zaczniesz korzystać z <a href="wiki.php?id=wiki:welcome">Twojego nowego EasyWiki</a>.';
...
$lang['i_pop_field']           = 'Proszę, pomóż nam ulepszyć doświadczenia z EasyWiki:';
$lang['i_pop_label']           = 'Raz na miesiąc, wysyłaj anonimowe statystyki do deweloperów EasyWiki';
...
$lang['email_signature_text']  = 'List został wygenerowany przez EasyWiki pod adresem
@EASYWIKIURL@';
