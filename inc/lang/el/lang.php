...
$lang['js']['medianolink']     = 'Να μη γίνει σύνδεσμος η εικόνα';
...
$lang['deletefail']            = 'Το αρχείο "%s" δε διαγράφηκε. Πιθανόν αυτό να οφείλεται στις ρυθμίσεις πρόσβασης του αρχείου.';
$lang['mediainuse']            = 'Το αρχείο "%s" δε διαγράφηκε - είναι ακόμα σε χρήση.';
$lang['namespaces']            = 'Φάκελοι';
$lang['mediafiles']            = 'Διαθέσιμα αρχεία σε';
$lang['accessdenied']          = 'Δε σας επιτρέπεται να δείτε αυτήν την σελίδα.';
...
$lang['ref_inuse']             = 'Το αρχείο δε μπορεί να διαγραφεί, επειδή είναι ακόμη σε χρήση από τις ακόλουθες σελίδες:';
...
$lang['skip_to_content']       = 'παράλειψη περιεχομένων';
