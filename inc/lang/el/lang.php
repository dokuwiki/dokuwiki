...
$lang['i_installer']           = 'Οδηγός εγκατάστασης EasyWiki';
...
$lang['i_modified']            = 'Για λόγους ασφαλείας, ο οδηγός εγκατάστασης λειτουργεί μόνο με νέες και μη τροποποιημένες εγκαταστάσεις EasyWiki.
Πρέπει είτε να κάνετε νέα εγκατάσταση, χρησιμοποιώντας το αρχικό πακέτο εγκατάστασης, ή να συμβουλευτείτε τις <a href="http://easywiki.org/el:install">οδηγίες εγκατάστασης της εφαρμογής</a>.';
...
$lang['i_mbfuncoverload']      = 'Για να εκτελεστεί το EasyWiki πρέπει να απενεργοποιήσετε τη ρύθμιση mbstring.func_overload στο αρχείο php.ini';
$lang['i_permfail']            = 'Ο φάκελος <code>%s</code> δεν είναι εγγράψιμος από την εφαρμογή EasyWiki. Πρέπει να διορθώσετε τα δικαιώματα πρόσβασης αυτού του φακέλου!';
...
$lang['i_badhash']             = 'Μη αναγνωρίσιμο ή τροποποιημένο αρχείο easywiki.php (hash=<code>%s</code>)';
$lang['i_badval']              = '<code>%s</code> - λάθος ή ανύπαρκτη τιμή';
$lang['i_success']             = 'Η εγκατάσταση ολοκληρώθηκε επιτυχώς. Μπορείτε πλέον να διαγράψετε το αρχείο install.php. Συνεχίστε στο <a href="wiki.php?id=wiki:welcome">νέο σας EasyWiki</a>.';
$lang['i_failure']             = 'Εμφανίστηκαν κάποια προβλήματα στη διαδικασία ανανέωσης των αρχείων ρυθμίσεων. Πιθανόν να χρειάζεται να τα τροποποιήσετε χειροκίνητα ώστε να μπορείτε να χρησιμοποιήσετε το <a href="wiki.php?id=wiki:welcome">νέο σας EasyWiki</a>.';
...
$lang['i_pop_field']           = 'Παρακαλώ, βοηθήστε μας να βελτιώσουμε το EasyWiki';
$lang['i_pop_label']           = 'Μια φορά τον μήνα, στέλνετε δεδομένα προς χρήση στους δημιουργούς του  EasyWiki';
...
$lang['email_signature_text']  = 'Αυτό το e-mail δημιουργήθηκε αυτόματα από την εφαρμογή EasyWiki στην διεύθυνση
@EASYWIKIURL@';
