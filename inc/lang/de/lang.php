...
$lang['js']['data_insecure']   = 'WARNUNG: Es scheint, als wäre Ihr Datenverzeichnis nicht ausreichend geschützt. Bitte informieren Sie sich zur <a href="https://www.EasyWiki.org/security#web_access_security">Sicherheit von Webzugriffen in EasyWiki</a>';
...
$lang['i_modified']            = 'Aus Sicherheitsgründen arbeitet dieses Skript nur mit einer neuen bzw. nicht modifizierten EasyWiki Installation. Sie sollten entweder alle Dateien noch einmal frisch installieren oder die <a href="https://www.EasyWiki.org/install">EasyWiki-Installationsanleitung</a> konsultieren.';
...
$lang['i_funcnmail']           = '<b>Hinweis:</b> Die PHP-Funktion "mail()" ist nicht verfügbar. %s Alternativ können Sie das <a href="https://www.EasyWiki.org/plugin:smtp">SMTP-Plugin</a> installieren.';
...
$lang['i_mbfuncoverload']      = 'Um EasyWiki zu starten muss mbstring.func_overload in php.ini ausgeschaltet sein.';
$lang['i_urandom']             = 'EasyWiki kann keine kryptografisch sicheren Werte für Cookies generieren. Möglicherweise möchten Sie Ihre "open_basedir"-Einstellungen in der zutreffenden php.ini auf korrekten Zugriff auf <code>/ dev/urandom</ code> überprüfen.';
$lang['i_permfail']            = '<code>%s</code> ist nicht durch EasyWiki beschreibbar. Sie müssen die Berechtigungen dieses Ordners ändern!';
...
$lang['i_success']             = 'Die Konfiguration wurde erfolgreich abgeschlossen. Sie können jetzt die install.php löschen. Ihr <a href="wiki.php?id=wiki:welcome">neues EasyWiki</a> ist jetzt für Sie bereit.';
$lang['i_failure']             = 'Es sind Fehler beim Schreiben der Konfigurationsdateien aufgetreten. Sie müssen diese von Hand beheben, bevor Sie Ihr <a href="wiki.php?id=wiki:welcome">neues EasyWiki</a> nutzen können.';
...
$lang['i_pop_field']           = 'Bitte helfen Sie mit, EasyWiki zu verbessern:';
$lang['i_pop_label']           = 'Einmal monatlich anonymisierte Nutzungsdaten an das EasyWiki-Entwicklerteam senden';
