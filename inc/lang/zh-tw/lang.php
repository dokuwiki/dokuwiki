...
$lang['willexpire']            = '您目前編輯這頁的鎖定將會在一分鐘內解除。若要避免發生衝突，請按「預覽」鍵重新設定鎖定計時。';
$lang['js']['notsavedyet']     = '尚未儲存的變更將會遺失，要繼續嗎？';
...
$lang['subscr_subscribe_success'] = '已將 %s 添加到 %s 的訂閱列表';
$lang['subscr_subscribe_error'] = '將 %s 添加到 %s 的訂閱列表時發生錯誤';
$lang['subscr_subscribe_noaddress'] = '沒有與您登入信息相關的地址，您無法被添加到訂閱列表';
...
$lang['subscr_m_not_subscribed'] = '您尚未訂閱目前頁面或命名空間。';
$lang['subscr_m_new_header']   = '添加訂閱';
...
$lang['i_funcna']              = 'PHP 函數 <code>%s</code> 無法使用。也許你的主機供應者基於某些理由停用了它？';
...
$lang['i_badval']              = '<code>%s</code> - 非法或空白值';
$lang['i_success']             = '設定已成功完成。您現在可以刪除 install.php 檔案。繼續到
<a href="doku.php">您的新 DokuWiki</a>.';
$lang['i_failure']             = '寫入設定檔時發生了一些錯誤。您必須在使用<a href="doku.php">你的新 Dokuwiki</a> 之前手動修正它們。';
