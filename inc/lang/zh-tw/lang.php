...
$lang['js']['media_drop']      = '將檔案拖放到此上傳';
$lang['js']['media_cancel']    = '刪除';
$lang['js']['media_overwrt']   = '覆蓋已存在的檔案';
$lang['search_exact_match']    = '完全相符';
$lang['search_contains']       = '包含';
$lang['search_custom_match']   = '自訂';
$lang['search_any_ns']         = '任何命名空間';
...
$lang['regsuccess']            = '已建立使用者帳號，密碼已寄發至該電郵。';
$lang['regsuccess2']           = '已建立使用者帳號。';
...
$lang['resendpwdconfirm']      = '確認連結已透過郵件發送給您了。';
$lang['resendpwdsuccess']      = '已寄出您的新密碼。';
$lang['license']               = '若無特別註明，本 wiki 上的內容都是採用以下授權方式：';
$lang['licenseok']             = '注意：編輯此頁面表示您同意用以下授權方式發布您撰寫的內容：';
$lang['searchmedia']           = '搜尋檔名：';
$lang['searchmedia_in']        = '在 %s 搜尋';
$lang['txt_upload']            = '請選擇要上傳的檔案:';
$lang['txt_filename']          = '請輸入要上傳至本 wiki 的檔案名稱（選擇性）：';
...
$lang['deletesucc']            = '已刪除檔案 "%s" 。';
$lang['deletefail']            = '無法刪除檔案 "%s" ，請檢查權限定。';
...
$lang['mediaroot']             = 'root';
$lang['mediaupload']           = '上傳檔案至目前命名空間之下。要建立子命名空間，請將其名稱加在「上傳並重命名為」檔案名的前面，並用英文冒號隔開。';
$lang['mediaextchange']        = '檔案類型已由 .%s 變更作 .%s ！';
$lang['reference']             = '引用到本頁的，合計有';
$lang['ref_inuse']             = '無法刪除此檔案，因以下頁面正在使用它：';
...
$lang['metaedit']              = '編輯詮釋資料';
$lang['metasaveerr']           = '無法寫入詮釋資料';
$lang['metasaveok']            = '已儲存詮釋資料';
$lang['img_title']             = '標題：';
...
$lang['img_width']             = '寬度：';
$lang['img_height']            = '高度：';
$lang['subscr_subscribe_success'] = '已將 %s 加入 %s 的訂閱列表';
$lang['subscr_subscribe_error'] = '將 %s 加入 %s 的訂閱列表時發生錯誤';
$lang['subscr_subscribe_noaddress'] = '沒有與您登入相關的地址，無法將您加入訂閱列表';
$lang['subscr_unsubscribe_success'] = '已將 %s 自 %s 的訂閱列表移除';
