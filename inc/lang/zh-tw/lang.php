...
$lang['nosecedit']             = '該頁面被改變的同時，部分訊息已經過時並以修改過的內容代替。';
...
$lang['license']               = '除了有特別聲明，這個 Wiki 中的內容使用下列授權方式：';
$lang['licenseok']             = '請注意：編輯此頁面，表示您同意以下列授權方式發布您的內容：';
...
$lang['uploadsize']            = '上傳的檔案大小太大了。（最大：%s）';
...
$lang['summary']               = '編輯摘要';
$lang['noflash']               = '您需要安裝 <a href="http://www.adobe.com/products/flashplayer/">Adobe Flash Plugin</a> 以顯示這個內容。';
...
$lang['i_problems']            = '安裝程式發現一些問題，顯示如下。您將無法繼續直到您修正它們。';
...
$lang['i_funcna']              = 'PHP 函式 <code>%s</code> 無法使用。也許您的主機供應者停用它或是其他原因？';
...
$lang['i_failure']             = '在寫入設定檔時發生了一些錯誤。您必須在使用<a href="doku.php">您的新 DokuWiki</a> 之前手動修正它們';
$lang['i_policy']              = '初步的ACL政策';
$lang['i_pol0']                = '開放的 Wiki（可被任何人讀取、寫入、上傳）';
$lang['i_pol1']                = '公開的 Wiki（可被任何人讀取，但是只能被註冊的使用者寫入與上傳）';
$lang['i_pol2']                = '封閉的 Wiki（只能被註冊的使用者讀取、寫入、上傳）';
$lang['i_retry']               = '重試';
...
$lang['recent_global']         = '您正在觀看 <b>%s</b> 中改變的部份。您也可以<a href="%s">檢視所有在 Wiki 上改變的部份</a>。';
