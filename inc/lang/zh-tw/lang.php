...
$lang['regpwmail']             = '您的 EasyWiki 帳號密碼';
...
$lang['i_installer']           = 'EasyWiki 安裝工具';
...
$lang['i_badhash']             = '無法辨識或已遭修改的 easywiki.php (hash=<code>%s</code>)';
$lang['i_badval']              = '<code>%s</code> —— 非法或空白的值';
$lang['i_success']             = '設定已完成。您現在可以刪除 install.php 檔案。繼續到
<a href="wiki.php?id=wiki:welcome">您的新 EasyWiki</a>.';
$lang['i_failure']             = '寫入設定檔時發生了一些錯誤。您必須在使用<a href="wiki.php?id=wiki:welcome">您的新 EasyWiki</a> 之前手動修正它們。';
...
$lang['i_pop_field']           = '請協助我們改進 EasyWiki：';
$lang['i_pop_label']           = '每月向 EasyWiki 開發者發送匿名的使用數據';
...
$lang['email_signature_text']  = '本信件由以下 EasyWiki 網站產生
@EASYWIKIURL@';
