...
<a href="http://www.EasyWiki.org/install">інструкцыі па ўсталёўцы «Докувики»</a>';
...
$lang['i_badhash']             = 'easywiki.php не распазнаны або зменены (hash=<code>%s</code>)';
...
<a href="wiki.php?id=wiki:welcome">сваёй новай «Докувики»</a>.';
$lang['i_failure']             = 'Пры запісу ў файлы канфігурацыі былі выяўленыя памылкі. Магчыма, вам прыйдзецца выправіць іх уручную, перш чым вы зможаце выкарыстоўваць <a href="wiki.php?id=wiki:welcome">сваю новую «Докувики»</a>.';
