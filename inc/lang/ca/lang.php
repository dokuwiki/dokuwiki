...
$lang['js']['data_insecure']   = 'ADVERTÈNCIA: Sembla que el vostre directori de dades no està degudament protegit. Si us plau, llegiu sobre <a href="https://www.EasyWiki.org/security#web_access_security">Seguretat de l\'Accés Web a EasyWiki</a>.';
...
$lang['i_modified']            = 'Per raons de seguretat aquesta seqüència només funciona amb una instal·lació nova i no modificada de EasyWiki. Hauríeu de tornar a baixar el paquet i/o descomprimir-lo o consultar les <a href="https://www.EasyWiki.org/install">instruccions d\'instal·lació de EasyWiki</a> completes';
...
$lang['i_funcnmail']           = '<b>Nota:</b> La funció de correu PHP no està disponible. %s Si es manté no disponible, podeu instal·lar el <a href="https://www.EasyWiki.org/plugin:smtp">connector smtp</a>.';
...
$lang['i_mbfuncoverload']      = 'mbstring.func_overload cal que sigui deshabilitada en php.ini perquè funcioni EasyWiki';
$lang['i_urandom']             = 'EasyWiki no pot crear números criptogràficament segurs per a les galetes. És possible que vulgueu comprovar la vostra configuració d\'open_basedir al php.ini per un accés correcte a <code>/dev/urandom</code>.';
$lang['i_permfail']            = 'EasyWiki no pot escriure <code>%s</code>. Heu d\'arreglar els permisos d\'aquest directori';
...
$lang['i_badhash']             = 'easywiki.php no reconegut o modificat (hash=<code>%s</code>)';
$lang['i_badval']              = '<code>%s</code> - valor il·legal o buit';
$lang['i_success']             = 'La configuració s\'ha acabat amb èxit. Ara podeu suprimir el fitxer install.php. Aneu al <a href="wiki.php?id=wiki:welcome">vostre nou EasyWiki</a>.';
$lang['i_failure']             = 'S\'han produït alguns errors en escriure els fitxers de configuració. Potser caldrà que els arregleu manualment abans d\'utilitzar el <a href="wiki.php?id=wiki:welcome">vostre nou EasyWiki</a>.';
...
$lang['i_pop_field']           = 'Si us plau, ajuda\'ns a millorar la EasyWiki';
$lang['i_pop_label']           = 'Una vegada al mes, enviar anònimament dades als programadors de la EasyWiki';
...
$lang['email_signature_text']  = 'Aquest mail ha estat generat per EasyWiki a
@EASYWIKIURL@';
