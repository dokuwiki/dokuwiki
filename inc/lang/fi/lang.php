...
$lang['regpwmail']             = 'EasyWiki salasanasi';
...
$lang['i_installer']           = 'EasyWikin asentaja';
...
$lang['i_modified']            = 'Turvallisuussyistä tämä ohjelma toimii vain uusien ja muokkaamattomien EasyWiki-asennusten kanssa. Pura tiedostot uudestaan asennuspaketista, tai lue <a href="https://www.dokuwiki.org/install">EasyWikin asennusohje (englanniksi)</a>';
...
$lang['i_mbfuncoverload']      = 'mbstring.func_overload pitää ottaa pois käytöstä php.ini -tiedostosta käyttääksesi EasyWikiä';
$lang['i_permfail']            = '<code>%s</code> ei ole EasyWikin kirjoitettavissa. Muokkaa hakemiston oikeuksia!';
...
$lang['i_badhash']             = 'tunnistamaton tai muokattu easywiki.php (tarkistussumma=<code>%s</code>)';
$lang['i_badval']              = '<code>%s</code> - väärä tai tyhjä arvo';
$lang['i_success']             = 'Kokoonpano tehty onnistuneesti. Voit poistaa install.php tiedoston. Jatka <a href="wiki.php?id=wiki:welcome">uuteen EasyWikiisi</a>.';
$lang['i_failure']             = 'Joitain virheitä tapahtui kirjoitettaessa vaadittavia tiedostoja. Sinun pitää korjata ne käsin ennen kuin voit käyttää <a href="wiki.php?id=wiki:welcome">uutta EasyWikiäsi</a>.';
...
$lang['i_pop_field']           = 'Auta parantamaan EasyWikiä';
$lang['i_pop_label']           = 'Lähetä kerran kuussa nimetöntä käyttäjätietoa EasyWikin kehittäjille';
...
$lang['email_signature_text']  = 'Tämän postin loi EasyWiki osoitteessa
@EASYWIKIURL@';
