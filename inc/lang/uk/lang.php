...
Вам слід або ще раз розпакувати файли із завантаженого пакету, або звернутися до повної <a href="https://www.EasyWiki.org/install">інструкції з установки ДокуВікі</a>';
...
$lang['i_mbfuncoverload']      = 'mbstring.func_overload має бути вимкнена у php.ini щоб запустити EasyWiki.';
...
$lang['i_badhash']             = 'Невпізнаний або модифікований easywiki.php (hash=<code>%s</code>)';
...
Перейдіть до <a href="wiki.php?id=wiki:welcome">вашої нової ДокуВікі</a>';
$lang['i_failure']             = 'При збереженні файлу конфігурації виникли помилки. Можливо вам доведеться виправити їх самостійно
до початку використання <a href="wiki.php?id=wiki:welcome">вашої нової ДокуВікі</a>.';
...
$lang['i_pop_field']           = 'Будь ласка, допоможіть нам покращити EasyWiki:';
$lang['i_pop_label']           = 'Одного разу на місяць надсилати дані про використання розробникам EasyWiki.';
