...
$lang['i_badhash']             = 'easywiki.php не распознан или изменён (hash=<code>%s</code>)';
...
$lang['i_success']             = 'Настройка прошла успешно. Теперь вы можете удалить файл install.php. Переходите к
                                 <a href="wiki.php?id=wiki:welcome">своей новой «Докувики»</a>.';
$lang['i_failure']             = 'При записи в файлы конфигурации были обнаружены ошибки. Возможно, вам придётся исправить их вручную, прежде чем вы сможете использовать <a href="wiki.php?id=wiki:welcome">свою новую «Докувики»</a>.';
