...
$lang['nosecedit']             = 'Ez a szakasz időközben megváltozott. A legújabb változat megtekintéséhez töltse újra az oldalt.';
$lang['searchcreatepage']      = 'Ha nem találja amit keresett, létrehozhatja vagy szerkesztheti a keresés alapján elnevezett %s oldalt.';
$lang['search_fullresults']    = 'Teljes szöveg';
$lang['js']['search_toggle_tools'] = 'Keresőeszközök be/ki';
$lang['js']['willexpire']      = 'Az oldalszerkesztési zárolása egy percen belül lejár.\nAz ütközések elkerülése végett használja az Előnézet gombot a zárolás frissítéséhez.';
...
$lang['js']['del_confirm']     = 'Valóban törölni akarja a kiválasztott elemeket?';
$lang['js']['restore_confirm'] = 'Valóban vissza akarja állítani ezt a változatot?';
...
$lang['js']['data_insecure']   = 'FIGYELEM: Úgy tűnik, hogy az adatokat tartalmazó mappa nincs biztonságosan beállítva. Tekintse át <a href="https://www.dokuwiki.org/security#web_access_security">biztonságos hozzáférés beállítását a DokuWikiben</a>.';
...
$lang['regmailfail']           = 'Hiba történt a jelszó elküldése során. Lépjen kapcsolatba az adminisztrátorokkal.';
$lang['regbadmail']            = 'A megadott e-mail-cím érvénytelennek tűnik. Ha úgy gondolja, hogy ez hiba, lépjen kapcsolatba az adminisztrátorokkal.';
$lang['regbadpass']            = 'A jelszavak nem egyeznek. Próbálja újra.';
$lang['regpwmail']             = 'A DokuWiki-jelszava';
$lang['reghere']               = 'Még nincs fiókja? Alább regisztrálhat';
...
$lang['profdeleted']           = 'Eltávolítottuk a felhasználói fiókját erről a wikiről.';
...
$lang['proftokeninfo']         = 'A hitelesítőkulcs arra használható, hogy harmadik felek alkalmazásai bejelentkezhessenek és tevékenykedhessenek a nevében. A kulcs visszaállítása letiltja a régi kulcsot, és kijelentkeztet minden alkalmazást, ami ezt használta.';
$lang['pwdforget']             = 'Elfelejtette a jelszavát? Itt kérhet újat';
...
$lang['resendpwdbadauth']      = 'A megerősítőkód helytelen. Biztos, hogy a teljes megerősítő-hivatkozást pontosan beírta?';
$lang['resendpwdconfirm']      = 'A megerősítő-hivatkozást e-mail-ben elküldtük.';
$lang['resendpwdsuccess']      = 'Elküldtük az új jelszavát e-mail-ben.';
...
$lang['txt_upload']            = 'Válassza ki a feltöltendő fájlt:';
...
$lang['deletefail']            = 'A(z) „%s” fájl nem törölhető – ellenőrizze a jogosultságokat.';
...
$lang['accessdenied']          = 'Nincs jogsultsága az oldal megtekintésére.';
$lang['mediausage']            = 'A következő formában hivatkozhat erre a fájlra:';
$lang['mediaview']             = 'Eredeti fájl megtekintése';
$lang['mediaroot']             = 'gyökérkönyvtár';
$lang['mediaupload']           = 'Itt tölthet fel állományokat az aktuális névtérbe. Alnévtér létrehozásához a „Feltöltési név” mezőben kell kettősponttal elválasztva megadnia azt.';
...
$lang['ref_hidden']            = 'Bizonyos hivatkozásokhoz nincs olvasási jogosultsága';
$lang['hits']                  = 'Találatok';
...
$lang['subscr_subscribe_noaddress'] = 'Az Ön felhasználói adatai nem tartalmaznak e-mail-címet, így a rendszer nem tudta felvenni az értesítési listára';
...
$lang['subscr_m_not_subscribed'] = 'Ön jelenleg nincs feliratkozva erre az oldalra vagy névtérre';
...
$lang['authtempfail']          = 'A felhasználó-azonosítás átmenetileg nem működik. Ha a probléma fennáll, értesítse az adminisztrátorokat.';
...
Csomagolja ki újra a fájlokat vagy tekintse meg a teljes <a href="https://www.dokuwiki.org/install">Dokuwiki telepítési útmutatót</a>.';
...
$lang['i_permfail']            = 'A DokuWiki nem tud írni a(z) <code>%s</code> könyvtárba. Be kell állítania ehhez a könyvtárhoz a megfelelő jogosultságokat.';
$lang['i_confexists']          = 'A(z) <code>%s</code> már létezik.';
$lang['i_writeerr']            = 'A(z) <code>%s</code> létrehozása sikertelen. Ellenőrizze a könyvtár-/fájljogosultságokat, és hozza létre az állományt kézzel.';
...
$lang['i_success']             = 'A beállítás sikeresen befejeződött. Az install.php fájl immár törölhető. Látogassa meg az <a href="doku.php?id=wiki:welcome">újonnan létrehozott DokuWikijét</a>!';
$lang['i_failure']             = 'Hiba lépett fel a konfigurációs állományok írásakor. Ki kell javítania kézzel, mielőtt használni kezdheti az <a href="doku.php?id=wiki:welcome">újonnan létrehozott DokuWikijét</a>.';
...
$lang['i_retry']               = 'Újra';
$lang['i_license']             = 'Válasszon licencet a feltöltött tartalomhoz:';
$lang['i_license_none']        = 'Ne jelenítsen meg licencinformációt';
$lang['i_pop_field']           = 'Kérjük, segítsen a DokuWiki továbbfejlesztésében:';
...
$lang['media_perm_read']       = 'Nincs jogsultsága a fájlok olvasásához.';
$lang['media_perm_upload']     = 'Nincs jogsultsága a feltöltéshez.';
...
$lang['search_nslimit']	       = 'Keresés korlátozása a jelenlegi X névtérre. Ha egy mélyebb névtérről indít keresést, akkor az első X névtér szűrőként lesz felhasználva.';
...
$lang['trustedproxies']        = 'A megbízható proxykiszolgálók vesszővel elválasztott listája, amelyekből kiolvasható az X-Forwarded-For fejléc. A lista minden eleme lehet IPv4/IPv6-cím, vagy IPv4/IPv6 CIDR-tartomány (pl.: 10.0.0.0/8). Ha ezt üresen hagyja, akkor egy proxyt sem kezelünk megbízhatóként.';