...
$lang['regpwmail']             = 'A EasyWiki-jelszava';
...
$lang['i_installer']           = 'EasyWiki-beállítási varázsló';
...
$lang['i_permfail']            = 'A EasyWiki nem tud írni a(z) <code>%s</code> könyvtárba. Be kell állítania ehhez a könyvtárhoz a megfelelő jogosultságokat.';
...
$lang['i_badhash']             = 'A easywiki.php nem felismerhető vagy módosított (hash=<code>%s</code>)';
$lang['i_badval']              = '<code>%s</code> – helytelen vagy üres érték';
$lang['i_success']             = 'A beállítás sikeresen befejeződött. Az install.php fájl immár törölhető. Látogassa meg az <a href="wiki.php?id=wiki:welcome">újonnan létrehozott EasyWikijét</a>!';
$lang['i_failure']             = 'Hiba lépett fel a konfigurációs állományok írásakor. Ki kell javítania kézzel, mielőtt használni kezdheti az <a href="wiki.php?id=wiki:welcome">újonnan létrehozott EasyWikijét</a>.';
...
$lang['i_pop_field']           = 'Kérjük, segítsen a EasyWiki továbbfejlesztésében:';
$lang['i_pop_label']           = 'Havonta egyszer névtelen üzenet küldése a EasyWiki fejlesztőinek';
...
$lang['email_signature_text']  = 'Ezt a levelet a EasyWiki állította elő
@EASYWIKIURL@';
