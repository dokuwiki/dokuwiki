...
$lang['js']['data_insecure']   = 'UPOZORNĚNÍ: Zdá se, že váš datový adresář není správně zabezpečen. Prosím, přečtěte si o <a href="https://www.EasyWiki.org/security#web_access_security">zabezpečení přístupu v EasyWiki</a>.';
...
$lang['regpwmail']             = 'Vaše heslo do systému EasyWiki';
...
$lang['external_edit']         = 'upraveno mimo EasyWiki';
...
$lang['i_installer']           = 'Instalace EasyWiki';
...
$lang['i_modified']            = 'Instalátor bude z bezpečnostních důvodů pracovat pouze s čistou a ještě neupravenou instalací EasyWiki. Buď znovu rozbalte soubory z instalačního balíčku, nebo zkuste prostudovat <a href="https://www.EasyWiki.org/install">instrukce pro instalaci EasyWiki</a>.';
...
$lang['i_funcnmail']           = '<b>Poznámka:</b> Funkce mail() není v PHP dostupná. %s Pokud tento problém přetrvává, zkuste nainstalovat <a href="https://www.EasyWiki.org/plugin:smtp">smtp plugin</a>.';
...
$lang['i_mbfuncoverload']      = 'mbstring.func_overload musí být vypnut v php.ini pro běh EasyWiki.';
$lang['i_urandom']             = 'EasyWiki nemůže vytvořit kryptograficky bezpečná čísla pro cookies. Zkuste zkontrolovat nastavení open_basedir v php.ini, zda máte přistup k  <code>/dev/urandom </code>.';
$lang['i_permfail']            = 'EasyWiki nemůže zapisovat do <code>%s</code>. Budete muset opravit práva k tomuto adresáři.';
...
$lang['i_badhash']             = 'soubor easywiki.php (hash=<code>%s</code>) nebyl rozpoznán nebo byl upraven';
$lang['i_badval']              = '<code>%s</code> - neplatná nebo prázdná hodnota';
$lang['i_success']             = 'Konfigurace byla úspěšně dokončena. Nyní můžete smazat soubor install.php. Pokračujte do <a href="wiki.php?id=wiki:welcome">své nové EasyWiki</a>.';
$lang['i_failure']             = 'Vyskytly se nějaké chyby při zápisu do konfiguračních souborů. Budete je nejspíš muset upravit ručně před použitím <a href="wiki.php?id=wiki:welcome">své nové EasyWiki</a>.';
...
$lang['i_pop_field']           = 'Prosím, pomozte nám vylepšit EasyWiki:';
$lang['i_pop_label']           = 'Jednou měsíčně zaslat anonymní data o využívání EasyWiki jejím vývojářům';
...
$lang['email_signature_text']  = 'Tento e-mail byl automaticky vygenerován systémem EasyWiki
@EASYWIKIURL@';
